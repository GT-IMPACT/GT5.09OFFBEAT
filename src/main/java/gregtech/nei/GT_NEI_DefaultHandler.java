...
import static com.impact.mods.GregTech.GTregister.GT_ItemList.DustWasherLV;
import static com.impact.mods.GregTech.GTregister.GT_ItemList.Machine_LV_ComponentAssembler;
...
//    return "gregtech:textures/gui/" + this.mRecipeMap.mUnlocalizedName + ".png";
    ...
    public class CachedDefaultRecipe
        ...
        public CachedDefaultRecipe(GT_Recipe aRecipe) {
            ...
            if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sHammerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Hammer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sOreWasherRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_OreWasher.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sThermalCentrifugeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_ThermalCentrifuge.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sCompressorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Compressor.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sExtractorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Extractor.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sScannerFakeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Scanner.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sRockBreakerFakeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_RockBreaker.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sReplicatorFakeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Replicator.get(1), 102, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sOrganicReplicatorFakeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_OrganicReplicator.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_PlasmaArcFurnace.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_ArcFurnace.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sPrinterRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Printer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sSifterRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Sifter.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sPressRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Press.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_LaserEngraver.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sMixerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Mixer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sAutoclaveRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Autoclave.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sElectroMagneticSeparatorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_ElectromagneticSeparator.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sPolarizerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Polarizer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sMaceratorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Macerator.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_ChemicalBath.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_FluidCanner.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sBrewingRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Brewery.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_FluidHeater.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sDistilleryRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Distillery.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sFermentingRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Fermenter.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sFluidSolidficationRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_FluidSolidifier.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_FluidExtractor.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sBoxinatorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Boxinator.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sUnboxinatorRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Unboxinator.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Centrifuge.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sElectrolyzerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Electrolyzer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sChemicalRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_ChemicalReactor.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sDustWashRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(DustWasherLV.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sWiremillRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Wiremill.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sAlloySmelterRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_AlloySmelter.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sAssemblerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Assembler.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_CircuitAssembler.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sWireAssemblerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_WireAssembler.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sComponentAssemblerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(Machine_LV_ComponentAssembler.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sCannerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Canner.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sLatheRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Lathe.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sCutterRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Cutter.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sSlicerRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Slicer.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sExtruderRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Extruder.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sAmplifiers) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Amplifab.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sMassFabFakeRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Massfab.get(1), 120, 52));
            } else if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sBenderRecipes) {
                this.mInputs.add(new GT_NEI_DefaultHandler.FixedPositionedStack(ItemList.Machine_LV_Bender.get(1), 120, 52));
            }
            ...
            switch (GT_NEI_DefaultHandler.this.mRecipeMap.mUsualInputCount) {
                ...
                case 33:
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 0));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 30, 0));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 48, 0));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 18));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 30, 18));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 48, 18));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 36));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 30, 36));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 48, 36));
                    }
                    tStartIndex++;
                    break;
                case 44:
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 66, 0));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 18));
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 66, 18));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 36));
                    ...
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 66, 36));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 12, 54));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 30, 54));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 48, 54));
                    }
                    tStartIndex++;
                    if (aRecipe.getRepresentativeInput(tStartIndex) != null) {
                        this.mInputs.add(new FixedPositionedStack(aRecipe.getRepresentativeInput(tStartIndex), 66, 54));
                    }
                    tStartIndex++;
                    break;
                default:
            ...
            switch (GT_NEI_DefaultHandler.this.mRecipeMap.mUsualOutputCount) {
                ...
                case 3344:
                    if (aRecipe.getOutput(tStartIndex) != null) {
                        this.mOutputs.add(new FixedPositionedStack(aRecipe.getOutput(tStartIndex), 138, 0, aRecipe.getOutputChance(tStartIndex)));
                    }
                    tStartIndex++;
                    break;
                default:
