...
public class GT_NEI_3DPrinter extends TemplateRecipeHandler {
    ...
    public TemplateRecipeHandler newInstance() {
        return new GT_NEI_3DPrinter(this.mRecipeMap);
    }
    ...
    public void drawExtras(int aRecipeIndex) {
        int tEUt = ((GT_NEI_3DPrinter.CachedDefaultRecipe) this.arecipes.get(aRecipeIndex)).mRecipe.mEUt;
        int tDuration = ((GT_NEI_3DPrinter.CachedDefaultRecipe) this.arecipes.get(aRecipeIndex)).mRecipe.mDuration;
        String[] recipeDesc = ((GT_NEI_3DPrinter.CachedDefaultRecipe) this.arecipes.get(aRecipeIndex)).mRecipe.getNeiDesc();
        if (recipeDesc == null) {
            if (tEUt != 0) {
            ...
            int tSpecial = ((GT_NEI_3DPrinter.CachedDefaultRecipe) this.arecipes.get(aRecipeIndex)).mRecipe.mSpecialValue;
    ...
    public class CachedDefaultRecipe
        ...
        public CachedDefaultRecipe(GT_Recipe aRecipe) {
            ...
            if (mRecipeMap == GT_Recipe.GT_Recipe_Map.sBasicline) {
                for (int i = 0; i < 16; i++) {
                ...
                for (int i = 0; i < 16; i++) {
                    Object obj = aRecipe instanceof GT_Recipe_WithAlt ? ((GT_Recipe_WithAlt) aRecipe).getAltRepresentativeInput(i) : aRecipe.getRepresentativeInput(i);
                    if (obj != null) {
                        this.mInputs.add(new FixedPositionedStack(obj, 18 * (i % 3) + 12, 18 * (i / 3)));
                    }
                }
            }
