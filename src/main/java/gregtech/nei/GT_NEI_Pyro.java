...
public class GT_NEI_Pyro
    ...
    public GT_NEI_Pyro(GT_Recipe.GT_Recipe_Map aRecipeMap) {//this is called when recipes should be shown
        this.mRecipeMap = aRecipeMap;
        this.transferRects.add(new RecipeTransferRect(new Rectangle(47, 30, 12, 11), getOverlayIdentifier(), new Object[0]));
    ...
    public class CachedDefaultRecipe
        ...
        public CachedDefaultRecipe(GT_Recipe aRecipe) {
            ...
            if (obj != null) {
                this.mInputs.add(new FixedPositionedStack(obj, 12, 27));
            }
        ...
        public List<PositionedStack> getIngredients() {
            return getCycledIngredients(GT_NEI_Pyro.this.cycleticks / 10, this.mInputs);
        }
