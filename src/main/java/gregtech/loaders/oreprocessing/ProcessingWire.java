    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        switch (aPrefix) {
            case wireGt01:
                ...
                if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_SMASHING)) {
                    GT_Values.RA.addBenderRecipe(GT_Utility.copyAmount(1L), GT_OreDictUnificator.get(OrePrefixes.springSmall, aMaterial, 2L), 100, 8);
                    GT_Values.RA.addWiremillRecipe(GT_Utility.copyAmount(1L), GT_OreDictUnificator.get(OrePrefixes.wireFine, aMaterial, 4L), 200, 8);
                ...
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(2L), ItemList.Circuit_Integrated.getWithDamage(0L, 2L, new Object[0])}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt02, aMaterial, 1L), 150, 8, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L, new Object[0])}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt04, aMaterial, 1L), 200, 8, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(8L), ItemList.Circuit_Integrated.getWithDamage(0L, 8L, new Object[0])}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt08, aMaterial, 1L), 300, 8, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(12L), ItemList.Circuit_Integrated.getWithDamage(0L, 12L, new Object[0])}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt12, aMaterial, 1L), 400, 8, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(16L), ItemList.Circuit_Integrated.getWithDamage(0L, 16L, new Object[0])}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt16, aMaterial, 1L), 500, 8, false);
                break;
            case wireGt02:
                cableWidth = 2;
                ...
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial)});
                break;
            case wireGt04:
                cableWidth = 4;
                ...
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial)});
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt02.get(aMaterial), OrePrefixes.wireGt02.get(aMaterial)});
                break;
            case wireGt08:
                cableWidth = 8;
                ...
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial),OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial), OrePrefixes.wireGt01.get(aMaterial)});
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt04.get(aMaterial), OrePrefixes.wireGt04.get(aMaterial)});
                break;
            case wireGt12:
                cableWidth = 12;
                ...
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt08.get(aMaterial), OrePrefixes.wireGt04.get(aMaterial)});
                break;
            case wireGt16:
                cableWidth = 16;
                ...
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt08.get(aMaterial), OrePrefixes.wireGt08.get(aMaterial)});
                GT_ModHandler.addShapelessCraftingRecipe(GT_Utility.copyAmount(1L), new Object[]{OrePrefixes.wireGt12.get(aMaterial), OrePrefixes.wireGt04.get(aMaterial)});
        ...
        switch (aMaterial.mName){
            case "RedAlloy":case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                ...
                GT_Values.RA.addBoxingRecipe(GT_Utility.copyAmount(1L), GT_OreDictUnificator.get(OrePrefixes.plate.get(Materials.Rubber), costMultiplier),  GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), 100, 8);
        ...
        GT_Values.RA.addUnboxingRecipe(GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), GT_Utility.copyAmount(1L), null, 100, 8);
        if (GT_Mod.gregtechproxy.mAE2Integration) {
            Api.INSTANCE.registries().p2pTunnel().addNewAttunement(aStack, TunnelType.IC2_POWER);
