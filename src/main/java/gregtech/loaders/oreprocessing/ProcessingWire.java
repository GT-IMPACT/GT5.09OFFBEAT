    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        ...
        switch (aPrefix) {
            case wireGt01:
                ...
                if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_SMASHING)) {
                    ...
                    GT_Values.RA.addWiremillRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.wireFine, aMaterial, 4L), 200, 6);
                ...
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(2L, new Object[]{aStack}), ItemList.Circuit_Integrated.getWithDamage(0L, 2L)}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt02, aMaterial, 1L), 150, 6, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4L, new Object[]{aStack}), ItemList.Circuit_Integrated.getWithDamage(0L, 4L)}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt04, aMaterial, 1L), 200, 6, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(8L, new Object[]{aStack}), ItemList.Circuit_Integrated.getWithDamage(0L, 8L)}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt08, aMaterial, 1L), 300, 6, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(12L, new Object[]{aStack}), ItemList.Circuit_Integrated.getWithDamage(0L, 12L)}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt12, aMaterial, 1L), 400, 6, false);
                GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(16L, new Object[]{aStack}), ItemList.Circuit_Integrated.getWithDamage(0L, 16L)}, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.wireGt16, aMaterial, 1L), 500, 6, false);
                break;
            case wireGt02:
                cableWidth = 2;
        ...
        switch (aMaterial.mName){
            case "RedAlloy":case "Cobalt": case "Lead": case "Tin": case "Zinc":case "SolderingAlloy":
                ...
                GT_Values.RA.addBoxingRecipe(GT_Utility.copyAmount(1L, new Object[]{aStack}), GT_OreDictUnificator.get(OrePrefixes.plate.get(Materials.Rubber), costMultiplier),  GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), 100, 6);
                GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 2L), GT_OreDictUnificator.get(OrePrefixes.wireGt01, aMaterial, 1L), GT_OreDictUnificator.get(OrePrefixes.cableGt01, aMaterial, 1L), 100, 6);
                GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 2L), GT_OreDictUnificator.get(OrePrefixes.wireGt02, aMaterial, 1L), GT_OreDictUnificator.get(OrePrefixes.cableGt02, aMaterial, 1L), 200, 12);
            ...
            case "Nichrome": case "Steel": case "BlackSteel": case "Titanium": case "Aluminium": case "BlueAlloy" :
            	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{aStack, GT_Utility.getIntegratedCircuit(24)}, Materials.Rubber.getMolten(144 * costMultiplier), 
                  		GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), 100, 6, false);        		
                ...
                for (Materials dielectric : dielectrics) {
                    for (Materials syntheticRubber : syntheticRubbers) {
                    	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier)},
                    			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 100, 6, false);
                    }
                }
            case "RedstoneAlloy":
            	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{aStack, GT_Utility.getIntegratedCircuit(24)}, Materials.Rubber.getMolten(144 * costMultiplier), 
                ...
                if (GT_Mod.gregtechproxy.mEasierIVPlusCables) {
                    ...
                    for (Materials dielectric : dielectrics) {
                        for (Materials syntheticRubber : syntheticRubbers) {
                        	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier)}, 
                        			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 400, 6, false);
                        	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier)},
                        			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 100, 6, false);
                        }
                    }
                	...
                	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{aStack, GT_OreDictUnificator.get(OrePrefixes.foil, aMaterial, costMultiplier), GT_Utility.getIntegratedCircuit(24)}, 
                			Materials.Silicone.getMolten(costMultiplier * 72), GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), 100, 6, false);
                    ...
                    for (Materials dielectric : dielectrics) {
                        for (Materials syntheticRubber : syntheticRubbers) {
                        	...
                        	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyphenyleneSulfide, costMultiplier * 4)}, 
                        			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 400, 6, false);
                        	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier), GT_OreDictUnificator.get(OrePrefixes.foil, aMaterial, costMultiplier)},
                        			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 100, 6, false);
                        	GT_Values.RA.addWireAssemblerRecipe(new ItemStack[]{GT_Utility.copyAmount(4, aStack), dielectric.getDust(costMultiplier), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.PolyphenyleneSulfide, costMultiplier)},
                        			syntheticRubber.getMolten(costMultiplier * 144), GT_OreDictUnificator.get(correspondingCable, aMaterial, 4L), 100, 6, false);
                        }
                    }
                }
        ...
        GT_Values.RA.addUnboxingRecipe(GT_OreDictUnificator.get(correspondingCable, aMaterial, 1L), GT_Utility.copyAmount(1L, new Object[]{aStack}), null, 100, 6);
        if (GT_Mod.gregtechproxy.mAE2Integration) {
			Api.INSTANCE.registries().p2pTunnel().addNewAttunement(aStack, tt);
