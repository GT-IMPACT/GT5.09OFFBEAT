    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        switch (aOreDictName) {
            ...
            case "foodDough":
                ...
                GT_Values.RA.addBenderRecipe(GT_Utility.copyAmount(1L), ItemList.Food_Flat_Dough.get(1L, new Object[0]), 16, 4);
                ...
                GT_Values.RA.addFormingPressRecipe(GT_Utility.copyAmount(1L), ItemList.Shape_Mold_Bun.get(0L, new Object[0]), ItemList.Food_Raw_Bun.get(1L, new Object[0]), 128, 4);
                GT_Values.RA.addFormingPressRecipe(GT_Utility.copyAmount(2L), ItemList.Shape_Mold_Bread.get(0L, new Object[0]), ItemList.Food_Raw_Bread.get(1L, new Object[0]), 256, 4);
                GT_Values.RA.addFormingPressRecipe(GT_Utility.copyAmount(3L), ItemList.Shape_Mold_Baguette.get(0L, new Object[0]), ItemList.Food_Raw_Baguette.get(1L, new Object[0]), 384, 4);
        }
    }
}
