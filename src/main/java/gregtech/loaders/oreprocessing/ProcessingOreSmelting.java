                    ...
                    case dust:
                    	...
                    	if (aMaterial.mDirectSmelting != aMaterial) {
                    		if (!aMaterial.contains(SubTag.DONT_ADD_DEFAULT_BBF_RECIPE)) {
                    	    	...
                    	    	GT_Values.RA.addPrimitiveBlastRecipe(aMaterial.getDust(4), new ItemStack(Blocks.sand, 4),       4, aMaterial.mDirectSmelting.getIngots(outputAmount), Materials.Ferrosilite.getDust(1 * outputAmount), 2400);
                    	    	GT_Values.RA.addPrimitiveBlastRecipe(aMaterial.getDust(3), Materials.Glass.getDust(2),          2, aMaterial.mDirectSmelting.getIngots(outputAmount), Materials.Ferrosilite.getDust(1 * outputAmount),  2400);
