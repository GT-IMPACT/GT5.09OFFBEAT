		...
		switch (aPrefix) {
			case plate:
				...
				switch (aMaterial.mName) {
					...
					case "Stone":
						...
						break;
					case "GraniteBlack":
						GregTech_API.registerCover(aStack, new GT_StdRenderedTexture(Textures.BlockIcons.GRANITE_BLACK_SMOOTH), null);
						break;
					case "GraniteRed":
						GregTech_API.registerCover(aStack, new GT_StdRenderedTexture(Textures.BlockIcons.GRANITE_RED_SMOOTH), null);
						break;
					case "Basalt":
						GregTech_API.registerCover(aStack, new GT_StdRenderedTexture(Textures.BlockIcons.BASALT_SMOOTH), null);
						break;
					case "Marble":
						GregTech_API.registerCover(aStack, new GT_StdRenderedTexture(Textures.BlockIcons.MARBLE_SMOOTH), null);
						break;
					case "Concrete":
						GregTech_API.registerCover(aStack, new GT_StdRenderedTexture(Textures.BlockIcons.CONCRETE_LIGHT_SMOOTH), null);
						break;
					default:
			...
			case plateDouble:
				...
				if (!aNoSmashing) {
					...
					GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 2L), ItemList.Circuit_Integrated.getWithDamage(0L, 2L), Materials.Glue.getFluid(10L), GT_Utility.copyAmount(1L, aStack), 64, 8);
				}
				break;
			case plateTriple:
				GT_ModHandler.removeRecipeByOutput(aStack);
				...
				if (!aNoSmashing) {
					...
					GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 3L), ItemList.Circuit_Integrated.getWithDamage(0L, 3L), Materials.Glue.getFluid(20L), GT_Utility.copyAmount(1L, aStack), 96, 8);
				}
				GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(1L, aStack), 2, GT_OreDictUnificator.get(OrePrefixes.compressed, aMaterial, 1L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh, 1L), new int[]{10000, 1000});//added
				break;
			case plateQuadruple:
				GT_ModHandler.removeRecipeByOutput(aStack);
				...
				if (!aNoSmashing) {
					...
					GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 4L), ItemList.Circuit_Integrated.getWithDamage(0L, 4L), Materials.Glue.getFluid(30L), GT_Utility.copyAmount(1L, aStack), 128, 8);
				}
				break;
			case plateQuintuple:
				GT_ModHandler.removeRecipeByOutput(aStack);
