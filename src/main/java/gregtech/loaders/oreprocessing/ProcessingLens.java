...
public class ProcessingLens implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    switch (aMaterial.mName) {
            case "Diamond":
                GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 4L), GT_OreDictUnificator.get(OrePrefixes.lens, aMaterial, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L), 1200, 30);
            ...
            case "Glass":
                ...
                break;
            default:
                GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, aMaterial, 4L), GT_OreDictUnificator.get(OrePrefixes.lens, aMaterial, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, aMaterial, 1L), 1200, 120);
