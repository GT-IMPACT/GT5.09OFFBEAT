...
//        ItemList.Processing_Array_T3.set(new GT_MetaTileEntity_ProcessingArray3(12074, "multimachine.processingarray.tier.08", "Processing Array Mk 3").getStackForm(1L));
    ...
    private static void run4() {
        ...
        makeWires(Materials.RedstoneAlloy, 11430, 2L, 1L, 2L, gregtech.api.enums.GT_Values.V[2], true, aBoolConst_0);
        ...
        makeWires(Materials.EnergeticAlloy, 11450, 2L, 1L, 3L, gregtech.api.enums.GT_Values.V[3], true, aBoolConst_0);
        ...
        makeWires(Materials.VibrantAlloy, 11470, 2L, 1L, 4L, gregtech.api.enums.GT_Values.V[5], true, aBoolConst_0);
