...
public class GT_Loader_MetaTileEntities implements Runnable {
    ...
    private static void run1() {
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Transformer_HV_MV.get(1L), bitsd, new Object[]{"KBB", "CM ", "KBB", 'M', ItemList.Hull_MV, 'C', OrePrefixes.cableGt01.get(Materials.Gold), 'B', OrePrefixes.cableGt01.get(Materials.Copper), 'K', ItemList.Circuit_Parts_Coil});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Machine_HP_Solar.get(1L), bits, new Object[]{"GGG", "SSS", aTextPlateMotor, 'M', ItemList.Machine_Bronze_Boiler_Solar, 'P', OrePrefixes.pipeSmall.get(Materials.Steel), 'S', OrePrefixes.plateTriple.get(Materials.Silver), 'G', GT_ModHandler.getModItem("IC2", "blockAlloyGlass", 1L)});
        ...
        ItemList.Locker_MAX.set(new GT_MetaTileEntity_Locker(159, "locker.tier.09", "MAX Locker", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_EV.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_EV, 'W', OrePrefixes.wireGt16.get(Materials.Aluminium), 'T', OreDictNames.craftingChest, 'B', ItemList.LapotronCrystal, 'C', OrePrefixes.circuit.get(Materials.Data)});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_ZPM.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_ZPM, 'W', OrePrefixes.wireGt16.get(Materials.Naquadah), 'T', OreDictNames.craftingChest, 'B', ItemList.Energy_Module, 'C', OrePrefixes.circuit.get(Materials.Ultimate)});
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_UV.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_UV, 'W', OrePrefixes.wireGt16.get(Materials.ElectrumFlux), 'T', OreDictNames.craftingChest, 'B', ItemList.Energy_Cluster, 'C', OrePrefixes.circuit.get(Materials.Superconductor)});
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_MAX.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_MAX, 'W', OrePrefixes.wireGt16.get(Materials.Superconductor), 'T', OreDictNames.craftingChest, 'B', ItemList.ZPM2, 'C', OrePrefixes.circuit.get(Materials.Infinite)});
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_UEV.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_UEV, 'W', OrePrefixes.wireGt16.get(Materials.SuperconductorUEV), 'T', OreDictNames.craftingChest, 'B', ItemList.ZPM2, 'C', OrePrefixes.circuit.get(Materials.Bio)});
        GT_ModHandler.addCraftingRecipe(ItemList.Battery_Charger_4by4_UIV.get(1L), bitsd, new Object[]{aTextWireChest, aTextWireHull, "BCB", 'M', ItemList.Hull_UIV, 'W', OrePrefixes.wireGt16.get(Materials.Neutronium), 'T', OreDictNames.craftingChest, 'B', ItemList.ZPM3, 'C', OrePrefixes.circuit.get(Materials.Nano)});
...
//        ItemList.Machine_UV_Macerator.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(308, "basicmachine.macerator.tier.08", "Blend-O-Matic 9001", 8, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMaceratorRecipes, 1, 4, 0, 0, 1, "Macerator4.png", GregTech_API.sSoundList.get(201), aBoolConst_0, aBoolConst_0, 1, "PULVERIZER", null).getStackForm(1L));
        ...
        ItemList.Machine_LV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(311, "basicmachine.microwave.tier.01", "LV Microwave", 1, "Did you really read the instruction Manual?", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", new Object[]{"LWC", "LMR", "LEC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'R', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'L', OrePrefixes.plate.get(Materials.Lead)}).getStackForm(1L));
        ItemList.Machine_MV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(312, "basicmachine.microwave.tier.02", "MV Microwave", 2, "Did you really read the instruction Manual?", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", new Object[]{"LWC", "LMR", "LEC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'R', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'L', OrePrefixes.plate.get(Materials.Lead)}).getStackForm(1L));
        ItemList.Machine_HV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(313, "basicmachine.microwave.tier.03", "HV Microwave", 3, "Did you really read the instruction Manual?", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", new Object[]{"LWC", "LMR", "LEC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'R', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'L', OrePrefixes.plate.get(Materials.Lead)}).getStackForm(1L));
        ItemList.Machine_EV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(314, "basicmachine.microwave.tier.04", "EV Microwave", 4, "Did you really read the instruction Manual?", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", new Object[]{"LWC", "LMR", "LEC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'R', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'L', OrePrefixes.plate.get(Materials.Lead)}).getStackForm(1L));
        ItemList.Machine_IV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(315, "basicmachine.microwave.tier.05", "IV Microwave", 5, "Did you really read the instruction Manual?", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", new Object[]{"LWC", "LMR", "LEC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'R', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'L', OrePrefixes.plate.get(Materials.Lead)}).getStackForm(1L));
//        ItemList.Machine_LuV_Microwave.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(316, "basicmachine.microwave.tier.06", "Advanced Microwave V", 6, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "MICROWAVE", null).getStackForm(1L));
...
//        ItemList.Machine_UV_FluidCanner.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(438, "basicmachine.fluidcanner.tier.08", "Instant Fluid Canner", 8, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 80000, 0, 1, "FluidCanner.png", "", true, aBoolConst_0, 0, "FLUID_CANNER", null).getStackForm(1L));
        ...
        //ItemList.Machine_LuV_Massfab.set(new GT_MetaTileEntity_Massfabricator(466, "basicmachine.massfab.tier.06", "LuV Mass Fabricator", 6).getStackForm(1L));
        //ItemList.Machine_ZPM_Massfab.set(new GT_MetaTileEntity_Massfabricator(467, "basicmachine.massfab.tier.07", "ZPM Mass Fabricator", 7).getStackForm(1L));
        //ItemList.Machine_UV_Massfab.set(new GT_MetaTileEntity_Massfabricator(468, "basicmachine.massfab.tier.08", "UV Mass Fabricator", 8).getStackForm(1L));
...
//        ItemList.Machine_UV_Amplifab.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(478, "basicmachine.amplifab.tier.08", "Advanced Amplifabricator IV", 8, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sAmplifiers, 1, 1, 1000, 0, 1, "Amplifabricator.png", GregTech_API.sSoundList.get(200), aBoolConst_0, aBoolConst_0, 0, "AMPLIFAB", null).getStackForm(1L));
        ...
        //ItemList.Machine_LuV_Replicator.set(new GT_MetaTileEntity_Replicator(486, "basicmachine.replicator.tier.06", "LuV Replicator", 6).getStackForm(1L));
        //ItemList.Machine_ZPM_Replicator.set(new GT_MetaTileEntity_Replicator(487, "basicmachine.replicator.tier.07", "ZPM Replicator", 7).getStackForm(1L));
        //ItemList.Machine_UV_Replicator.set(new GT_MetaTileEntity_Replicator(488, "basicmachine.replicator.tier.08", "UV Replicator", 8).getStackForm(1L));
...
//        ItemList.Machine_LuV_Distillery.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(536, "basicmachine.distillery.tier.06", "Advanced Distillery V", 6, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sDistilleryRecipes, 1, 1, 1000, 0, 1, "Distillery.png", GregTech_API.sSoundList.get(200), aBoolConst_0, aBoolConst_0, 0, "DISTILLERY", null).getStackForm(1L));
...
//        ItemList.Machine_LuV_LaserEngraver.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(596, "basicmachine.laserengraver.tier.06", "Advanced Precision Laser Engraver V", 6, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes, 2, 1, 0, 0, 1, "LaserEngraver.png", GregTech_API.sSoundList.get(212), aBoolConst_0, aBoolConst_0, 0, "LASER_ENGRAVER", null).getStackForm(1L));
...
//        ItemList.Machine_LuV_FluidHeater.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(626, "basicmachine.fluidheater.tier.06", "LuV Fluid Heater", 6, "Heating up your Fluids", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", aBoolConst_0, aBoolConst_0, 0, "FLUID_HEATER", null).getStackForm(1L));
//        ItemList.Machine_ZPM_FluidHeater.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(627, "basicmachine.fluidheater.tier.07", "ZPM Fluid Heater", 7, "Heating up your Fluids", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", aBoolConst_0, aBoolConst_0, 0, "FLUID_HEATER", null).getStackForm(1L));
//        ItemList.Machine_UV_FluidHeater.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(628, "basicmachine.fluidheater.tier.08", "UV Fluid Heater", 8, "Heating up your Fluids", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", aBoolConst_0, aBoolConst_0, 0, "FLUID_HEATER", null).getStackForm(1L));

//        GT_ModHandler.addCraftingRecipe(ItemList.Machine_LuV_FluidHeater.get(1L), bitsd, new Object[]{"WGW", "PHP", "ACA", 'H', ItemList.Hull_LuV, 'W', OrePrefixes.wireGt04.get(Materials.HSSG), 'P', ItemList.Electric_Pump_LuV, 'C', OrePrefixes.circuit.get(Materials.Master), 'A', OrePrefixes.cableGt01.get(Materials.VanadiumGallium), 'G', Ic2Items.reinforcedGlass});
//        GT_ModHandler.addCraftingRecipe(ItemList.Machine_ZPM_FluidHeater.get(1L), bitsd, new Object[]{"WGW", "PHP", "ACA", 'H', ItemList.Hull_ZPM, 'W', OrePrefixes.wireGt04.get(Materials.Naquadah), 'P', ItemList.Electric_Pump_ZPM, 'C', OrePrefixes.circuit.get(Materials.Ultimate), 'A', OrePrefixes.cableGt01.get(Materials.Naquadah), 'G', Ic2Items.reinforcedGlass});
//        GT_ModHandler.addCraftingRecipe(ItemList.Machine_UV_FluidHeater.get(1L), bitsd, new Object[]{"WGW", "PHP", "ACA", 'H', ItemList.Hull_UV, 'W', OrePrefixes.wireGt04.get(Materials.NaquadahAlloy), 'P', ItemList.Electric_Pump_UV, 'C', OrePrefixes.circuit.get(Materials.Superconductor), 'A', OrePrefixes.cableGt01.get(Materials.NaquadahAlloy), 'G', Ic2Items.reinforcedGlass});
...
//        ItemList.Machine_LuV_PlasmaArcFurnace.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(666, "basicmachine.plasmaarcfurnace.tier.06", "LuV Plasma Arc Furnace V", 6, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 16000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), aBoolConst_0, aBoolConst_0, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));
//        ItemList.Machine_ZPM_PlasmaArcFurnace.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(667, "basicmachine.plasmaarcfurnace.tier.07", "ZPM Plasma Arc Furnace VI", 7, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 24000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), aBoolConst_0, aBoolConst_0, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));
//        ItemList.Machine_UV_PlasmaArcFurnace.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(668, "basicmachine.plasmaarcfurnace.tier.08", "UV Plasma Arc Furnace VII", 8, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 32000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), aBoolConst_0, aBoolConst_0, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));

        ItemList.Machine_LV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(671, "basicmachine.e_oven.tier.01", "LV Electric Oven", 1, "Just a Furnace with a different Design", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", new Object[]{"CEC", aTextCableHull, "WEW", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.COIL_HEATING}).getStackForm(1L));
        ItemList.Machine_MV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(672, "basicmachine.e_oven.tier.02", "MV Electric Oven", 2, "Just a Furnace with a different Design", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", new Object[]{"CEC", aTextCableHull, "WEW", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.COIL_HEATING}).getStackForm(1L));
        ItemList.Machine_HV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(673, "basicmachine.e_oven.tier.03", "HV Electric Oven", 3, "Just a Furnace with a different Design", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", new Object[]{"CEC", aTextCableHull, "WEW", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.COIL_HEATING}).getStackForm(1L));
        ItemList.Machine_EV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(674, "basicmachine.e_oven.tier.04", "EV Electric Oven", 4, "Just a Furnace with a different Design", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", new Object[]{"CEC", aTextCableHull, "WEW", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.COIL_HEATING}).getStackForm(1L));
        ItemList.Machine_IV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(675, "basicmachine.e_oven.tier.05", "IV Electric Oven", 5, "Just a Furnace with a different Design", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", new Object[]{"CEC", aTextCableHull, "WEW", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.COIL_HEATING}).getStackForm(1L));
//        ItemList.Machine_LuV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(676, "basicmachine.e_oven.tier.06", "LuV Electric Oven V", 6, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", null).getStackForm(1L));
//        ItemList.Machine_ZPM_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(677, "basicmachine.e_oven.tier.07", "ZPM Electric Oven VI", 7, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", null).getStackForm(1L));
//        ItemList.Machine_UV_Oven.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(678, "basicmachine.e_oven.tier.08", "UV Electric Oven VII", 8, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Oven.png", GregTech_API.sSoundList.get(207), aBoolConst_0, aBoolConst_0, 0, "ELECTRIC_OVEN", null).getStackForm(1L));
    ...
    private static void run3() {
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Machine_Multi_BlastFurnace.get(1L), bitsd, new Object[]{"FFF", aTextCableHull, aTextWireCoil, 'M', ItemList.Casing_HeatProof, 'F', ItemList.Machine_LV_Oven, 'C', OrePrefixes.circuit.get(Materials.Basic), 'W', OrePrefixes.cableGt01.get(Materials.Tin)});
        GT_ModHandler.addCraftingRecipe(ItemList.Machine_Multi_Furnace.get(1L), bitsd, new Object[]{"FFF", aTextCableHull, aTextWireCoil, 'M', ItemList.Casing_HeatProof, 'F', ItemList.Machine_MV_Oven, 'C', OrePrefixes.circuit.get(Materials.Good), 'W', OrePrefixes.cableGt01.get(Materials.AnnealedCopper)});
...
//        ItemList.Processing_Array_T3.set(new GT_MetaTileEntity_ProcessingArray3(12074, "multimachine.processingarray.tier.08", "Processing Array Mk 3").getStackForm(1L));
        ...
        ItemList.Pump_LuV.set(new GT_MetaTileEntity_Pump(1132, "basicmachine.pump.tier.06", "LuV Pump V", 6).getStackForm(1L));
        ItemList.Pump_ZPM.set(new GT_MetaTileEntity_Pump(1133, "basicmachine.pump.tier.07", "ZPM Pump VI", 7).getStackForm(1L));
        ItemList.Pump_UV.set(new GT_MetaTileEntity_Pump(1134, "basicmachine.pump.tier.08", "UV Pump VII", 8).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Pump_LuV.get(1L), bitsd, new Object[]{"CPC", aTextPlateMotor, "BPB", 'M', ItemList.Hull_LuV, 'B', OrePrefixes.pipeLarge.get(Materials.NiobiumTitanium), 'C', OrePrefixes.circuit.get(Materials.Master), 'P', ItemList.Electric_Pump_LuV});
        GT_ModHandler.addCraftingRecipe(ItemList.Pump_ZPM.get(1L), bitsd, new Object[]{"CPC", aTextPlateMotor, "BPB", 'M', ItemList.Hull_ZPM, 'B', OrePrefixes.pipeLarge.get(Materials.Enderium), 'C', OrePrefixes.circuit.get(Materials.Ultimate), 'P', ItemList.Electric_Pump_ZPM});
        GT_ModHandler.addCraftingRecipe(ItemList.Pump_UV.get(1L), bitsd, new Object[]{"CPC", aTextPlateMotor, "BPB", 'M', ItemList.Hull_UV, 'B', OrePrefixes.pipeLarge.get(Materials.Naquadah), 'C', OrePrefixes.circuit.get(Materials.Superconductor), 'P', ItemList.Electric_Pump_UV});

        //ItemList.Machine_LV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(682, "basicmachine.e_watergenerator.tier.01", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Basic Electric Water Condenser", 1).getStackForm(1L));
        //ItemList.Machine_MV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(683, "basicmachine.e_watergenerator.tier.02", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Advanced Electric Water Condenser", 2).getStackForm(1L));
        //ItemList.Machine_HV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(684, "basicmachine.e_watergenerator.tier.03", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Advanced Electric Water Condenser II", 3).getStackForm(1L));
        //ItemList.Machine_EV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(685, "basicmachine.e_watergenerator.tier.04", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Advanced Electric Water Condenser III", 4).getStackForm(1L));
        //ItemList.Machine_IV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(686, "basicmachine.e_watergenerator.tier.05", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Advanced Electric Water Condenser IV", 5).getStackForm(1L));
        //ItemList.Machine_LuV_WaterGenerator.set(new GT_MetaTileEntity_WaterGenerator(687, "basicmachine.e_watergenerator.tier.06", EnumChatFormatting.DARK_RED + "[DELETED]" + EnumChatFormatting.RESET + " Advanced Electric Water Condenser V", 6).getStackForm(1L));
        ...
        ItemList.MobRep_HV.set(new GT_MetaTileEntity_MonsterRepellent(1148, "basicmachine.mobrep.tier.03", "HV Monster Repellator", 3).getStackForm(1L));
        ItemList.MobRep_EV.set(new GT_MetaTileEntity_MonsterRepellent(1149, "basicmachine.mobrep.tier.04", "EV Monster Repellator", 4).getStackForm(1L));
        ItemList.MobRep_IV.set(new GT_MetaTileEntity_MonsterRepellent(1150, "basicmachine.mobrep.tier.05", "IV Monster Repellator", 5).getStackForm(1L));
        ItemList.MobRep_LuV.set(new GT_MetaTileEntity_MonsterRepellent(1135, "basicmachine.mobrep.tier.06", "LuV Monster Repellator", 6).getStackForm(1L));
        ItemList.MobRep_ZPM.set(new GT_MetaTileEntity_MonsterRepellent(1136, "basicmachine.mobrep.tier.07", "ZPM Monster Repellator", 7).getStackForm(1L));
        ItemList.MobRep_UV.set(new GT_MetaTileEntity_MonsterRepellent(1137, "basicmachine.mobrep.tier.08", "UV Monster Repellator", 8).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.MobRep_UV.get(1L), bitsd, new Object[]{"EEE", " M ", "CCC", 'M', ItemList.Hull_UV, 'E', ItemList.Emitter_UV.get(1L), 'C', OrePrefixes.circuit.get(Materials.Superconductor)});
        ...
        //ItemList.Seismic_Prospector_LV.set(new GT_MetaTileEntity_SeismicProspector(1156, "basicmachine.seismicprospector.01", "LV Seismic Prospector", 1).getStackForm(1));
        //ItemList.Seismic_Prospector_MV.set(new GT_MetaTileEntity_SeismicProspector(2100, "basicmachine.seismicprospector.02", "MV Seismic Prospector", 2).getStackForm(1));
        //ItemList.Seismic_Prospector_HV.set(new GT_MetaTileEntity_SeismicProspector(2101, "basicmachine.seismicprospector.03", "HV Seismic Prospector", 3).getStackForm(1));

        ItemList.Seismic_Prospector_Adv_LV.set(new GT_MetaTileEntity_AdvSeismicProspector(2102, "basicmachine.seismicprospector.07", "LV Seismic Prospector", 1, 5 * 16 / 2, 2).getStackForm(1));
        ItemList.Seismic_Prospector_Adv_MV.set(new GT_MetaTileEntity_AdvSeismicProspector(2103, "basicmachine.seismicprospector.06", "MV Seismic Prospector", 2, 7 * 16 / 2, 2).getStackForm(1));
        ItemList.Seismic_Prospector_Adv_HV.set(new GT_MetaTileEntity_AdvSeismicProspector(2104, "basicmachine.seismicprospector.05", "HV Seismic Prospector", 3, 9 * 16 / 2, 2).getStackForm(1));
        ItemList.Seismic_Prospector_Adv_EV.set(new GT_MetaTileEntity_AdvSeismicProspector(1173, "basicmachine.seismicprospector.04", "EV Seismic Prospector", 4, 128, 2).getStackForm(1));
    ...
    private static void run4() {
        ...
        ItemList.Automation_ChestBuffer_MAX.set(new GT_MetaTileEntity_ChestBuffer(9239, "automation.chestbuffer.tier.09", "MAX Chest Buffer", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_ChestBuffer_MAX.get(1L), bitsd, new Object[]{"CMV", " X ", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'C', OreDictNames.craftingChest, 'X', OrePrefixes.circuit.get(Materials.Basic)});
        ...
        ItemList.Automation_Filter_MAX.set(new GT_MetaTileEntity_Filter(9249, "automation.filter.tier.09", "MAX Item Filter", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_Filter_MAX.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'C', OreDictNames.craftingChest, 'F', OreDictNames.craftingFilter, 'X', OrePrefixes.circuit.get(Materials.Basic)});
        ...
        ItemList.Automation_TypeFilter_MAX.set(new GT_MetaTileEntity_TypeFilter(9259, "automation.typefilter.tier.09", "MAX Type Filter", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_TypeFilter_MAX.get(1L), bitsd, new Object[]{" F ", "CMV", " X ", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'C', OreDictNames.craftingChest, 'F', OreDictNames.craftingFilter, 'X', OrePrefixes.circuit.get(Materials.Advanced)});
        ...
        ItemList.Automation_Regulator_MAX.set(new GT_MetaTileEntity_Regulator(9279, "automation.regulator.tier.09", "MAX Regulator", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_Regulator_MAX.get(1L), bitsd, new Object[]{"XFX", "VMV", "XCX", 'M', ItemList.Hull_MAX, 'V', ItemList.Robot_Arm_UV, 'C', OreDictNames.craftingChest, 'F', OreDictNames.craftingFilter, 'X', OrePrefixes.circuit.get(Materials.Advanced)});
        ...
        ItemList.Automation_SuperBuffer_MAX.set(new GT_MetaTileEntity_SuperBuffer(9309, "automation.superbuffer.tier.09", "MAX Super Buffer", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_SuperBuffer_MAX.get(1L), bitsd, new Object[]{"DMV", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'D', ItemList.Tool_DataOrb});
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_SuperBuffer_MAX.get(1L), bitsd, new Object[]{"DMV", "DDD", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'D', ItemList.Tool_DataStick});
        ...
        ItemList.Automation_ItemDistributor_MAX.set(new GT_MetaTileEntity_ItemDistributor(9329, "automation.itemdistributor.tier.09", "MAX Item Distributor", 9).getStackForm(1L));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Automation_ItemDistributor_MAX.get(1L), bitsd, new Object[]{"XCX", "VMV", " V ", 'M', ItemList.Hull_MAX, 'V', ItemList.Conveyor_Module_UV, 'C', OreDictNames.craftingChest, 'X', OrePrefixes.circuit.get(Materials.Good)});
...
//        ItemList.Generator_Plasma_UXV.set(new GT_MetaTileEntity_PlasmaGenerator(10757, "basicgenerator.plasmagenerator.tier.13", "UXV Plasma Generator", 13).getStackForm(1L));
        ...
        */
        ...
        //Compressor
        //ItemList.CompressorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10813, "basicmachine.compressor.tier.09", "Epic Matter Constrictor", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCompressorRecipes, 1, 1, 0, 0, 1, "Compressor.png", GregTech_API.sSoundList.get(203), false, false, 0, "COMPRESSOR", null).getStackForm(1L));
        //ItemList.CompressorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10814, "basicmachine.compressor.tier.10", "Epic Matter Constrictor II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCompressorRecipes, 1, 1, 0, 0, 1, "Compressor.png", GregTech_API.sSoundList.get(203), false, false, 0, "COMPRESSOR", null).getStackForm(1L));
        //ItemList.CompressorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10815, "basicmachine.compressor.tier.11", "Epic Matter Constrictor III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCompressorRecipes, 1, 1, 0, 0, 1, "Compressor.png", GregTech_API.sSoundList.get(203), false, false, 0, "COMPRESSOR", null).getStackForm(1L));
        //ItemList.CompressorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10816, "basicmachine.compressor.tier.12", "Epic Matter Constrictor IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCompressorRecipes, 1, 1, 0, 0, 1, "Compressor.png", GregTech_API.sSoundList.get(203), false, false, 0, "COMPRESSOR", null).getStackForm(1L));


        //CuttingMaching
        //ItemList.CuttingMachineUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10823, "basicmachine.cutter.tier.09", "Epic Object Divider", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCutterRecipes, 2, 2, 1000, 0, 1, "Cutter2.png", "", false, false, 0, "CUTTER", null).getStackForm(1L));
        //ItemList.CuttingMachineUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10824, "basicmachine.cutter.tier.10", "Epic Object Divider II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCutterRecipes, 2, 2, 1000, 0, 1, "Cutter2.png", "", false, false, 0, "CUTTER", null).getStackForm(1L));
        //ItemList.CuttingMachineUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10825, "basicmachine.cutter.tier.11", "Epic Object Divider III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCutterRecipes, 2, 2, 1000, 0, 1, "Cutter2.png", "", false, false, 0, "CUTTER", null).getStackForm(1L));
        //ItemList.CuttingMachineUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10826, "basicmachine.cutter.tier.12", "Epic Object Divider IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCutterRecipes, 2, 2, 1000, 0, 1, "Cutter2.png", "", false, false, 0, "CUTTER", null).getStackForm(1L));


        //Distillery
        //ItemList.DistilleryUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10833, "basicmachine.distillery.tier.09", "Epic Fraction Splitter", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sDistilleryRecipes, 1, 1, 1000, 0, 1, "Distillery.png", GregTech_API.sSoundList.get(200), false, false, 0, "DISTILLERY", null).getStackForm(1L));
        //ItemList.DistilleryUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10834, "basicmachine.distillery.tier.10", "Epic Fraction Splitter II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sDistilleryRecipes, 1, 1, 1000, 0, 1, "Distillery.png", GregTech_API.sSoundList.get(200), false, false, 0, "DISTILLERY", null).getStackForm(1L));
        //ItemList.DistilleryUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10835, "basicmachine.distillery.tier.11", "Epic Fraction Splitter III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sDistilleryRecipes, 1, 1, 1000, 0, 1, "Distillery.png", GregTech_API.sSoundList.get(200), false, false, 0, "DISTILLERY", null).getStackForm(1L));
        //ItemList.DistilleryUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10836, "basicmachine.distillery.tier.12", "Epic Fraction Splitter IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sDistilleryRecipes, 1, 1, 1000, 0, 1, "Distillery.png", GregTech_API.sSoundList.get(200), false, false, 0, "DISTILLERY", null).getStackForm(1L));


        //EFurnace
        //ItemList.ElectricFurnaceUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10843, "basicmachine.e_furnace.tier.09", "Epic Atom Stimulator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "ELECTRIC_FURNACE", null).getStackForm(1L));
        //ItemList.ElectricFurnaceUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10844, "basicmachine.e_furnace.tier.10", "Epic Atom Stimulator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "ELECTRIC_FURNACE", null).getStackForm(1L));
        //ItemList.ElectricFurnaceUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10845, "basicmachine.e_furnace.tier.11", "Epic Atom Stimulator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "ELECTRIC_FURNACE", null).getStackForm(1L));
        //ItemList.ElectricFurnaceUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10846, "basicmachine.e_furnace.tier.12", "Epic Atom Stimulator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFurnaceRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "ELECTRIC_FURNACE", null).getStackForm(1L));


        //Electrolyzer
        //ItemList.ElectrolyzerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10853, "basicmachine.electrolyzer.tier.09", "Epic Ionizer", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectrolyzerRecipes, 2, 6, 64000, 0, 1, "Electrolyzer.png", "", false, false, 0, "ELECTROLYZER", new Object[]{"IGI", "IMI", "CWC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'I', OrePrefixes.wireGt01.get(Materials.Osmium), 'G', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.GLASS}).getStackForm(1L));
        //ItemList.ElectrolyzerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10854, "basicmachine.electrolyzer.tier.10", "Epic Ionizer II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectrolyzerRecipes, 2, 6, 64000, 0, 1, "Electrolyzer.png", "", false, false, 0, "ELECTROLYZER", new Object[]{"IGI", "IMI", "CWC", 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.MOTOR, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'I', OrePrefixes.wireGt01.get(Materials.Osmium), 'G', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.GLASS}).getStackForm(1L));
        //ItemList.ElectrolyzerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10855, "basicmachine.electrolyzer.tier.11", "Epic Ionizer III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectrolyzerRecipes, 2, 6, 64000, 0, 1, "Electrolyzer.png", "", false, false, 0, "ELECTROLYZER", null).getStackForm(1L));
        //ItemList.ElectrolyzerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10856, "basicmachine.electrolyzer.tier.12", "Epic Ionizer IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectrolyzerRecipes, 2, 6, 64000, 0, 1, "Electrolyzer.png", "", false, false, 0, "ELECTROLYZER", null).getStackForm(1L));


        //ElectromagneticSeparator
        //ItemList.ElectromagneticSeparatorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10863, "basicmachine.electromagneticseparator.tier.09", "Epic Magnetar Separator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectroMagneticSeparatorRecipes, 1, 3, 0, 0, 1, "ElectromagneticSeparator.png", GregTech_API.sSoundList.get(212), false, false, 0, "ELECTROMAGNETIC_SEPARATOR", null).getStackForm(1L));
        //ItemList.ElectromagneticSeparatorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10864, "basicmachine.electromagneticseparator.tier.10", "Epic Magnetar Separator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectroMagneticSeparatorRecipes, 1, 3, 0, 0, 1, "ElectromagneticSeparator.png", GregTech_API.sSoundList.get(212), false, false, 0, "ELECTROMAGNETIC_SEPARATOR", null).getStackForm(1L));
        //ItemList.ElectromagneticSeparatorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10865, "basicmachine.electromagneticseparator.tier.11", "Epic Magnetar Separator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectroMagneticSeparatorRecipes, 1, 3, 0, 0, 1, "ElectromagneticSeparator.png", GregTech_API.sSoundList.get(212), false, false, 0, "ELECTROMAGNETIC_SEPARATOR", null).getStackForm(1L));
        //ItemList.ElectromagneticSeparatorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10866, "basicmachine.electromagneticseparator.tier.12", "Epic Magnetar Separator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sElectroMagneticSeparatorRecipes, 1, 3, 0, 0, 1, "ElectromagneticSeparator.png", GregTech_API.sSoundList.get(212), false, false, 0, "ELECTROMAGNETIC_SEPARATOR", null).getStackForm(1L));


        //Extractor
        //ItemList.ExtractorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10873, "basicmachine.extractor.tier.09", "Epic Extractinator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtractorRecipes, 1, 1, 0, 0, 1, "Extractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "EXTRACTOR", null).getStackForm(1L));
        //ItemList.ExtractorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10874, "basicmachine.extractor.tier.10", "Epic Extractinator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtractorRecipes, 1, 1, 0, 0, 1, "Extractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "EXTRACTOR", null).getStackForm(1L));
        //ItemList.ExtractorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10875, "basicmachine.extractor.tier.11", "Epic Extractinator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtractorRecipes, 1, 1, 0, 0, 1, "Extractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "EXTRACTOR", null).getStackForm(1L));
        //ItemList.ExtractorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10876, "basicmachine.extractor.tier.12", "Epic Extractinator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtractorRecipes, 1, 1, 0, 0, 1, "Extractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "EXTRACTOR", null).getStackForm(1L));


        //Extruder
        //ItemList.ExtruderUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10883, "basicmachine.extruder.tier.09", "Epic Shape Driver", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtruderRecipes, 2, 1, 0, 0, 1, "Extruder.png", GregTech_API.sSoundList.get(208), false, false, 0, "EXTRUDER", null).getStackForm(1L));
        //ItemList.ExtruderUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10884, "basicmachine.extruder.tier.10", "Epic Shape Driver II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtruderRecipes, 2, 1, 0, 0, 1, "Extruder.png", GregTech_API.sSoundList.get(208), false, false, 0, "EXTRUDER", null).getStackForm(1L));
        //ItemList.ExtruderUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10885, "basicmachine.extruder.tier.11", "Epic Shape Driver III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtruderRecipes, 2, 1, 0, 0, 1, "Extruder.png", GregTech_API.sSoundList.get(208), false, false, 0, "EXTRUDER", null).getStackForm(1L));
        //ItemList.ExtruderUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10886, "basicmachine.extruder.tier.12", "Epic Shape Driver IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sExtruderRecipes, 2, 1, 0, 0, 1, "Extruder.png", GregTech_API.sSoundList.get(208), false, false, 0, "EXTRUDER", null).getStackForm(1L));


        //FluidSolidifier
        //ItemList.FluidSolidifierUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10893, "basicmachine.fluidsolidifier.tier.09", "Epic Fluid Petrificator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidSolidficationRecipes, 1, 1, 16000, 0, 1, "FluidSolidifier.png", "", false, false, 0, "FLUID_SOLIDIFIER", null).getStackForm(1L));
        //ItemList.FluidSolidifierUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10894, "basicmachine.fluidsolidifier.tier.10", "Epic Fluid Petrificator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidSolidficationRecipes, 1, 1, 16000, 0, 1, "FluidSolidifier.png", "", false, false, 0, "FLUID_SOLIDIFIER", null).getStackForm(1L));
        //ItemList.FluidSolidifierUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10895, "basicmachine.fluidsolidifier.tier.11", "Epic Fluid Petrificator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidSolidficationRecipes, 1, 1, 16000, 0, 1, "FluidSolidifier.png", "", false, false, 0, "FLUID_SOLIDIFIER", null).getStackForm(1L));
        //ItemList.FluidSolidifierUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10896, "basicmachine.fluidsolidifier.tier.12", "Epic Fluid Petrificator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidSolidficationRecipes, 1, 1, 16000, 0, 1, "FluidSolidifier.png", "", false, false, 0, "FLUID_SOLIDIFIER", null).getStackForm(1L));


        //FormingPress
        //ItemList.FormingPressUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10903, "basicmachine.press.tier.09", "Epic Surface Shifter", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPressRecipes, 2, 1, 0, 0, 1, "Press.png", GregTech_API.sSoundList.get(203), false, false, 0, "PRESS", null).getStackForm(1L));
        //ItemList.FormingPressUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10904, "basicmachine.press.tier.10", "Epic Surface Shifter II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPressRecipes, 2, 1, 0, 0, 1, "Press.png", GregTech_API.sSoundList.get(203), false, false, 0, "PRESS", null).getStackForm(1L));
        //ItemList.FormingPressUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10905, "basicmachine.press.tier.11", "Epic Surface Shifter III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPressRecipes, 2, 1, 0, 0, 1, "Press.png", GregTech_API.sSoundList.get(203), false, false, 0, "PRESS", null).getStackForm(1L));
        //ItemList.FormingPressUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10906, "basicmachine.press.tier.12", "Epic Surface Shifter IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPressRecipes, 2, 1, 0, 0, 1, "Press.png", GregTech_API.sSoundList.get(203), false, false, 0, "PRESS", null).getStackForm(1L));


        //ForgeHammer
        //ItemList.ForgeHammerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10913, "basicmachine.hammer.tier.09", "Epic Impact Modulator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sHammerRecipes, 1, 1, 0, 6, 3, "Hammer.png", GregTech_API.sSoundList.get(1), false, false, 0, "HAMMER", null).getStackForm(1L));
        //ItemList.ForgeHammerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10914, "basicmachine.hammer.tier.10", "Epic Impact Modulator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sHammerRecipes, 1, 1, 0, 6, 3, "Hammer.png", GregTech_API.sSoundList.get(1), false, false, 0, "HAMMER", null).getStackForm(1L));
        //ItemList.ForgeHammerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10915, "basicmachine.hammer.tier.11", "Epic Impact Modulator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sHammerRecipes, 1, 1, 0, 6, 3, "Hammer.png", GregTech_API.sSoundList.get(1), false, false, 0, "HAMMER", null).getStackForm(1L));
        //ItemList.ForgeHammerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10916, "basicmachine.hammer.tier.12", "Epic Impact Modulator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sHammerRecipes, 1, 1, 0, 6, 3, "Hammer.png", GregTech_API.sSoundList.get(1), false, false, 0, "HAMMER", null).getStackForm(1L));


        //Lathe
        //ItemList.LatheUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10923, "basicmachine.lathe.tier.09", "Epic Turn-O-Matic", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLatheRecipes, 1, 2, 0, 0, 1, "Lathe.png", "", false, false, 0, "LATHE", null).getStackForm(1L));
        //ItemList.LatheUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10924, "basicmachine.lathe.tier.10", "Epic Turn-O-Matic II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLatheRecipes, 1, 2, 0, 0, 1, "Lathe.png", "", false, false, 0, "LATHE", null).getStackForm(1L));
        //ItemList.LatheUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10925, "basicmachine.lathe.tier.11", "Epic Turn-O-Matic III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLatheRecipes, 1, 2, 0, 0, 1, "Lathe.png", "", false, false, 0, "LATHE", null).getStackForm(1L));
        //ItemList.LatheUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10926, "basicmachine.lathe.tier.12", "Epic Turn-O-Matic IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLatheRecipes, 1, 2, 0, 0, 1, "Lathe.png", "", false, false, 0, "LATHE", null).getStackForm(1L));


        //PrecisionLaserEngraver
        //ItemList.PrecisionLaserEngraverUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10933, "basicmachine.laserengraver.tier.09", "Epic Exact Photon Cannon", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes, 2, 1, 0, 0, 1, "LaserEngraver.png", GregTech_API.sSoundList.get(212), false, false, 0, "LASER_ENGRAVER", null).getStackForm(1L));
        //ItemList.PrecisionLaserEngraverUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10934, "basicmachine.laserengraver.tier.10", "Epic Exact Photon Cannon II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes, 2, 1, 0, 0, 1, "LaserEngraver.png", GregTech_API.sSoundList.get(212), false, false, 0, "LASER_ENGRAVER", null).getStackForm(1L));
        //ItemList.PrecisionLaserEngraverUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10935, "basicmachine.laserengraver.tier.11", "Epic Exact Photon Cannon III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes, 2, 1, 0, 0, 1, "LaserEngraver.png", GregTech_API.sSoundList.get(212), false, false, 0, "LASER_ENGRAVER", null).getStackForm(1L));
        //ItemList.PrecisionLaserEngraverUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10936, "basicmachine.laserengraver.tier.12", "Epic Exact Photon Cannon IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sLaserEngraverRecipes, 2, 1, 0, 0, 1, "LaserEngraver.png", GregTech_API.sSoundList.get(212), false, false, 0, "LASER_ENGRAVER", null).getStackForm(1L));


        //Macerator
        //ItemList.MaceratorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10943, "basicmachine.macerator.tier.09", "Epic Shape Eliminator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMaceratorRecipes, 1, 4, 0, 0, 1, "Macerator4.png", GregTech_API.sSoundList.get(201), false, false, 1, "PULVERIZER", null).getStackForm(1L));
        //ItemList.MaceratorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10944, "basicmachine.macerator.tier.10", "Epic Shape Eliminator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMaceratorRecipes, 1, 4, 0, 0, 1, "Macerator4.png", GregTech_API.sSoundList.get(201), false, false, 1, "PULVERIZER", null).getStackForm(1L));
        //ItemList.MaceratorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10945, "basicmachine.macerator.tier.11", "Epic Shape Eliminator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMaceratorRecipes, 1, 4, 0, 0, 1, "Macerator4.png", GregTech_API.sSoundList.get(201), false, false, 1, "PULVERIZER", null).getStackForm(1L));
        //ItemList.MaceratorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10946, "basicmachine.macerator.tier.12", "Epic Shape Eliminator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMaceratorRecipes, 1, 4, 0, 0, 1, "Macerator4.png", GregTech_API.sSoundList.get(201), false, false, 1, "PULVERIZER", null).getStackForm(1L));
        ...
        //ItemList.MicrowaveUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10964, "basicmachine.microwave.tier.10", "Epic UFO Engine II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "MICROWAVE", null).getStackForm(1L));
        //ItemList.MicrowaveUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10965, "basicmachine.microwave.tier.11", "Epic UFO Engine III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "MICROWAVE", null).getStackForm(1L));
        //ItemList.MicrowaveUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10966, "basicmachine.microwave.tier.12", "Epic UFO Engine IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMicrowaveRecipes, 1, 1, 0, 0, 1, "E_Furnace.png", GregTech_API.sSoundList.get(207), false, false, 0, "MICROWAVE", null).getStackForm(1L));


        //OreWasher
        //ItemList.OreWashingPlantUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10973, "basicmachine.orewasher.tier.09", "Epic Ore Washing Machine", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sOreWasherRecipes, 1, 3, 16000, 0, 1, "OreWasher.png", "", false, false, 0, "ORE_WASHER", null).getStackForm(1L));
        //ItemList.OreWashingPlantUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10974, "basicmachine.orewasher.tier.10", "Epic Ore Washing Machine II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sOreWasherRecipes, 1, 3, 16000, 0, 1, "OreWasher.png", "", false, false, 0, "ORE_WASHER", null).getStackForm(1L));
        //ItemList.OreWashingPlantUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10975, "basicmachine.orewasher.tier.11", "Epic Ore Washing Machine III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sOreWasherRecipes, 1, 3, 16000, 0, 1, "OreWasher.png", "", false, false, 0, "ORE_WASHER", null).getStackForm(1L));
        //ItemList.OreWashingPlantUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10976, "basicmachine.orewasher.tier.12", "Epic Ore Washing Machine IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sOreWasherRecipes, 1, 3, 16000, 0, 1, "OreWasher.png", "", false, false, 0, "ORE_WASHER", null).getStackForm(1L));


        //Polarizer
        //ItemList.PolarizerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10983, "basicmachine.polarizer.tier.09", "Epic Magnetism Inducer", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPolarizerRecipes, 1, 1, 0, 0, 1, "Polarizer.png", GregTech_API.sSoundList.get(212), false, false, 0, "POLARIZER", null).getStackForm(1L));
        //ItemList.PolarizerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10984, "basicmachine.polarizer.tier.10", "Epic Magnetism Inducer II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPolarizerRecipes, 1, 1, 0, 0, 1, "Polarizer.png", GregTech_API.sSoundList.get(212), false, false, 0, "POLARIZER", null).getStackForm(1L));
        //ItemList.PolarizerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10985, "basicmachine.polarizer.tier.11", "Epic Magnetism Inducer III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPolarizerRecipes, 1, 1, 0, 0, 1, "Polarizer.png", GregTech_API.sSoundList.get(212), false, false, 0, "POLARIZER", null).getStackForm(1L));
        //ItemList.PolarizerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10986, "basicmachine.polarizer.tier.12", "Epic Magnetism Inducer IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPolarizerRecipes, 1, 1, 0, 0, 1, "Polarizer.png", GregTech_API.sSoundList.get(212), false, false, 0, "POLARIZER", null).getStackForm(1L));


        //Recycler
        //ItemList.RecyclerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10993, "basicmachine.recycler.tier.09", "Epic Scrap-O-Matic", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sRecyclerRecipes, 1, 1, 0, 0, 1, "Recycler.png", GregTech_API.sSoundList.get(204), false, false, 0, "RECYCLER", null).getStackForm(1L));
        //ItemList.RecyclerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10994, "basicmachine.recycler.tier.10", "Epic Scrap-O-Matic II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sRecyclerRecipes, 1, 1, 0, 0, 1, "Recycler.png", GregTech_API.sSoundList.get(204), false, false, 0, "RECYCLER", null).getStackForm(1L));
        //ItemList.RecyclerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10995, "basicmachine.recycler.tier.11", "Epic Scrap-O-Matic III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sRecyclerRecipes, 1, 1, 0, 0, 1, "Recycler.png", GregTech_API.sSoundList.get(204), false, false, 0, "RECYCLER", null).getStackForm(1L));
        //ItemList.RecyclerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(10996, "basicmachine.recycler.tier.12", "Epic Scrap-O-Matic IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sRecyclerRecipes, 1, 1, 0, 0, 1, "Recycler.png", GregTech_API.sSoundList.get(204), false, false, 0, "RECYCLER", null).getStackForm(1L));
        ...
        ItemList.ScannerUIV.set(new GT_MetaTileEntity_Scanner(11015, "basicmachine.scanner.tier.11", "UIV Electron Microscope", 11).getStackForm(1L));
        ItemList.ScannerUMV.set(new GT_MetaTileEntity_Scanner(11016, "basicmachine.scanner.tier.12", "UMV Electron Microscope", 12).getStackForm(1L));


        //Sifter
        //ItemList.SiftingMachineUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11023, "basicmachine.sifter.tier.09", "Epic Pulsation Filter", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSifterRecipes, 1, 9, 0, 2, 5, "Sifter.png", "", false, false, 0, "SIFTER", null).getStackForm(1L));
        //ItemList.SiftingMachineUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11024, "basicmachine.sifter.tier.10", "Epic Pulsation Filter II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSifterRecipes, 1, 9, 0, 2, 5, "Sifter.png", "", false, false, 0, "SIFTER", null).getStackForm(1L));
        //ItemList.SiftingMachineUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11025, "basicmachine.sifter.tier.11", "Epic Pulsation Filter III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSifterRecipes, 1, 9, 0, 2, 5, "Sifter.png", "", false, false, 0, "SIFTER", null).getStackForm(1L));
        //ItemList.SiftingMachineUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11026, "basicmachine.sifter.tier.12", "Epic Pulsation Filter IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSifterRecipes, 1, 9, 0, 2, 5, "Sifter.png", "", false, false, 0, "SIFTER", null).getStackForm(1L));


        //SlicingMachine
        //ItemList.SlicingMachineUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11033, "basicmachine.slicer.tier.09", "Epic Quantum Slicer", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSlicerRecipes, 2, 1, 0, 0, 1, "Slicer.png", "", false, false, 0, "SLICER", null).getStackForm(1L));
        //ItemList.SlicingMachineUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11034, "basicmachine.slicer.tier.10", "Epic Quantum Slicer II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSlicerRecipes, 2, 1, 0, 0, 1, "Slicer.png", "", false, false, 0, "SLICER", null).getStackForm(1L));
        //ItemList.SlicingMachineUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11035, "basicmachine.slicer.tier.11", "Epic Quantum Slicer III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSlicerRecipes, 2, 1, 0, 0, 1, "Slicer.png", "", false, false, 0, "SLICER", null).getStackForm(1L));
        //ItemList.SlicingMachineUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11036, "basicmachine.slicer.tier.12", "Epic Quantum Slicer IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sSlicerRecipes, 2, 1, 0, 0, 1, "Slicer.png", "", false, false, 0, "SLICER", null).getStackForm(1L));


        //ThermalCentrifuge
        //ItemList.ThermalCentrifugeUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11043, "basicmachine.thermalcentrifuge.tier.09", "Epic Fire Cyclone", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sThermalCentrifugeRecipes, 1, 3, 0, 0, 1, "ThermalCentrifuge.png", "", false, false, 0, "THERMAL_CENTRIFUGE", null).getStackForm(1L));
        //ItemList.ThermalCentrifugeUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11044, "basicmachine.thermalcentrifuge.tier.10", "Epic Fire Cyclone II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sThermalCentrifugeRecipes, 1, 3, 0, 0, 1, "ThermalCentrifuge.png", "", false, false, 0, "THERMAL_CENTRIFUGE", null).getStackForm(1L));
        //ItemList.ThermalCentrifugeUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11045, "basicmachine.thermalcentrifuge.tier.11", "Epic Fire Cyclone III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sThermalCentrifugeRecipes, 1, 3, 0, 0, 1, "ThermalCentrifuge.png", "", false, false, 0, "THERMAL_CENTRIFUGE", null).getStackForm(1L));
        //ItemList.ThermalCentrifugeUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11046, "basicmachine.thermalcentrifuge.tier.12", "Epic Fire Cyclone IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sThermalCentrifugeRecipes, 1, 3, 0, 0, 1, "ThermalCentrifuge.png", "", false, false, 0, "THERMAL_CENTRIFUGE", null).getStackForm(1L));


        //Wiremill
        //ItemList.WiremillUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11053, "basicmachine.wiremill.tier.09", "Epic Wire Transfigurator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sWiremillRecipes, 1, 1, 0, 0, 1, "Wiremill.png", GregTech_API.sSoundList.get(204), false, false, 0, "WIREMILL", null).getStackForm(1L));
        //ItemList.WiremillUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11054, "basicmachine.wiremill.tier.10", "Epic Wire Transfigurator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sWiremillRecipes, 1, 1, 0, 0, 1, "Wiremill.png", GregTech_API.sSoundList.get(204), false, false, 0, "WIREMILL", null).getStackForm(1L));
        //ItemList.WiremillUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11055, "basicmachine.wiremill.tier.11", "Epic Wire Transfigurator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sWiremillRecipes, 1, 1, 0, 0, 1, "Wiremill.png", GregTech_API.sSoundList.get(204), false, false, 0, "WIREMILL", null).getStackForm(1L));
        //ItemList.WiremillUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11056, "basicmachine.wiremill.tier.12", "Epic Wire Transfigurator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sWiremillRecipes, 1, 1, 0, 0, 1, "Wiremill.png", GregTech_API.sSoundList.get(204), false, false, 0, "WIREMILL", null).getStackForm(1L));


        //ArcFurnace
        //ItemList.ArcFurnaceUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11073, "basicmachine.arcfurnace.tier.09", "Epic Short Circuit Heater", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes, 1, 1, 128000, 0, 1, "ArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "ARC_FURNACE", null).getStackForm(1L));
        //ItemList.ArcFurnaceUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11074, "basicmachine.arcfurnace.tier.10", "Epic Short Circuit Heater II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes, 1, 1, 128000, 0, 1, "ArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "ARC_FURNACE", null).getStackForm(1L));
        //ItemList.ArcFurnaceUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11075, "basicmachine.arcfurnace.tier.11", "Epic Short Circuit Heater III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes, 1, 1, 128000, 0, 1, "ArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "ARC_FURNACE", null).getStackForm(1L));
        //ItemList.ArcFurnaceUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11076, "basicmachine.arcfurnace.tier.12", "Epic Short Circuit Heater IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sArcFurnaceRecipes, 1, 1, 128000, 0, 1, "ArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "ARC_FURNACE", null).getStackForm(1L));


        //Centrifuge
        //ItemList.CentrifugeUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11083, "basicmachine.centrifuge.tier.09", "Epic Molecular Tornado", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes, 2, 6, 128000, 0, 1, "Centrifuge.png", "", false, false, 0, "CENTRIFUGE", null).getStackForm(1L));
        //ItemList.CentrifugeUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11084, "basicmachine.centrifuge.tier.10", "Epic Molecular Tornado II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes, 2, 6, 256000, 0, 1, "Centrifuge.png", "", false, false, 0, "CENTRIFUGE", null).getStackForm(1L));
        //ItemList.CentrifugeUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11085, "basicmachine.centrifuge.tier.11", "Epic Molecular Tornado III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes, 2, 6, 512000, 0, 1, "Centrifuge.png", "", false, false, 0, "CENTRIFUGE", null).getStackForm(1L));
        //ItemList.CentrifugeUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11086, "basicmachine.centrifuge.tier.12", "Epic Molecular Tornado IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCentrifugeRecipes, 2, 6, 1024000, 0, 1, "Centrifuge.png", "", false, false, 0, "CENTRIFUGE", null).getStackForm(1L));


        //PlasmaArcFurnace
        //ItemList.PlasmaArcFurnaceUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11093, "basicmachine.plasmaarcfurnace.tier.09", "Epic Plasma Discharge Heater", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 128000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));
        //ItemList.PlasmaArcFurnaceUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11094, "basicmachine.plasmaarcfurnace.tier.10", "Epic Plasma Discharge Heater II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 128000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));
        //ItemList.PlasmaArcFurnaceUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11095, "basicmachine.plasmaarcfurnace.tier.11", "Epic Plasma Discharge Heater III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 128000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));
        //ItemList.PlasmaArcFurnaceUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11096, "basicmachine.plasmaarcfurnace.tier.12", "Epic Plasma Discharge Heater IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sPlasmaArcFurnaceRecipes, 1, 4, 128000, 0, 1, "PlasmaArcFurnace.png", GregTech_API.sSoundList.get(202), false, false, 0, "PLASMA_ARC_FURNACE", null).getStackForm(1L));


        //Brewer
        //ItemList.BreweryUHV.set(new GT_MetaTileEntity_PotionBrewer(11123, "basicmachine.brewery.tier.09", "UHV Brew Rusher", 9).getStackForm(1L));
        //ItemList.BreweryUEV.set(new GT_MetaTileEntity_PotionBrewer(11124, "basicmachine.brewery.tier.10", "UEV Brew Rusher", 10).getStackForm(1L));
        //ItemList.BreweryUIV.set(new GT_MetaTileEntity_PotionBrewer(11125, "basicmachine.brewery.tier.11", "UIV Brew Rusher", 11).getStackForm(1L));
        //ItemList.BreweryUMV.set(new GT_MetaTileEntity_PotionBrewer(11126, "basicmachine.brewery.tier.12", "UMV Brew Rusher", 12).getStackForm(1L));
        //ItemList.BreweryUXV.set(new GT_MetaTileEntity_PotionBrewer(11127, "basicmachine.brewery.tier.13", "UXV Brew Rusher", 13).getStackForm(1L));
        //ItemList.BreweryOPV.set(new GT_MetaTileEntity_PotionBrewer(11128, "basicmachine.brewery.tier.14", "OPV Brew Rusher", 14).getStackForm(1L));


        //CanningMachine
        //ItemList.CanningMachineUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11133, "basicmachine.canner.tier.09", "Epic Can Operator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));
        //ItemList.CanningMachineUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11134, "basicmachine.canner.tier.10", "Epic Can Operator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));
        //ItemList.CanningMachineUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11135, "basicmachine.canner.tier.11", "Epic Can Operator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));
        //ItemList.CanningMachineUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11136, "basicmachine.canner.tier.12", "Epic Can Operator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));
        //ItemList.CanningMachineUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11137, "basicmachine.canner.tier.13", "Epic Can Operator V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));
        //ItemList.CanningMachineOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11138, "basicmachine.canner.tier.14", "Epic Can Operator VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCannerRecipes, 2, 2, 0, 0, 1, "Canner.png", GregTech_API.sSoundList.get(200), false, false, 0, "CANNER", null).getStackForm(1L));


        //ChemicalBath
        //ItemList.ChemicalBathUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11143, "basicmachine.chemicalbath.tier.09", "Epic Chemical Dunktron", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));
        //ItemList.ChemicalBathUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11144, "basicmachine.chemicalbath.tier.10", "Epic Chemical Dunktron II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));
        //ItemList.ChemicalBathUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11145, "basicmachine.chemicalbath.tier.11", "Epic Chemical Dunktron III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));
        //ItemList.ChemicalBathUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11146, "basicmachine.chemicalbath.tier.12", "Epic Chemical Dunktron IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));
        //ItemList.ChemicalBathUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11147, "basicmachine.chemicalbath.tier.13", "Epic Chemical Dunktron V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));
        //ItemList.ChemicalBathOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11148, "basicmachine.chemicalbath.tier.14", "Epic Chemical Dunktron VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalBathRecipes, 1, 3, 8000, 0, 1, "ChemicalBath.png", "", false, true, 0, "CHEMICAL_BATH", null).getStackForm(1L));


        //ChemicalReactor
        //ItemList.ChemicalReactorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11153, "basicmachine.chemicalreactor.tier.09", "Epic Chemical Performer", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        //ItemList.ChemicalReactorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11154, "basicmachine.chemicalreactor.tier.10", "Epic Chemical Performer II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        //ItemList.ChemicalReactorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11155, "basicmachine.chemicalreactor.tier.11", "Epic Chemical Performer III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        //ItemList.ChemicalReactorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11156, "basicmachine.chemicalreactor.tier.12", "Epic Chemical Performer IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        //ItemList.ChemicalReactorUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11157, "basicmachine.chemicalreactor.tier.13", "Epic Chemical Performer V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        //ItemList.ChemicalReactorOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11158, "basicmachine.chemicalreactor.tier.14", "Epic Chemical Performer VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sChemicalRecipes, 2, 2, 16000, 0, 1, "ChemicalReactor.png", GregTech_API.sSoundList.get(200), false, false, 0, "CHEMICAL_REACTOR", null).getStackForm(1L));
        ...
        //Fermenter
        //ItemList.FermenterUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11173, "basicmachine.fermenter.tier.09", "Epic Fermentation Hastener", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 2000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));
        //ItemList.FermenterUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11174, "basicmachine.fermenter.tier.10", "Epic Fermentation Hastener II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 2000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));
        //ItemList.FermenterUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11175, "basicmachine.fermenter.tier.11", "Epic Fermentation Hastener III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 4000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));
        //ItemList.FermenterUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11176, "basicmachine.fermenter.tier.12", "Epic Fermentation Hastener IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 4000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));
        //ItemList.FermenterUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11177, "basicmachine.fermenter.tier.13", "Epic Fermentation Hastener V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 8000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));
        //ItemList.FermenterOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11178, "basicmachine.fermenter.tier.14", "Epic Fermentation Hastener VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFermentingRecipes, 1, 1, 8000, 0, 1, "Fermenter.png", "", false, false, 0, "FERMENTER", null).getStackForm(1L));


        //FluidCanner
        //ItemList.FluidCannerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11183, "basicmachine.fluidcanner.tier.09", "Epic Liquid Can Actuator", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 144000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));
        //ItemList.FluidCannerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11184, "basicmachine.fluidcanner.tier.10", "Epic Liquid Can Actuator II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 160000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));
        //ItemList.FluidCannerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11185, "basicmachine.fluidcanner.tier.11", "Epic Liquid Can Actuator III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 176000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));
        //ItemList.FluidCannerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11186, "basicmachine.fluidcanner.tier.12", "Epic Liquid Can Actuator IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 192000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));
        //ItemList.FluidCannerUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11187, "basicmachine.fluidcanner.tier.13", "Epic Liquid Can Actuator V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 192000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));
        //ItemList.FluidCannerOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11188, "basicmachine.fluidcanner.tier.14", "Epic Liquid Can Actuator VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidCannerRecipes, 1, 1, 192000, 0, 1, "FluidCanner.png", "", true, false, 0, "FLUID_CANNER", null).getStackForm(1L));


        //FluidExtractor
        //ItemList.FluidExtractorUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11193, "basicmachine.fluidextractor.tier.09", "Epic Liquefying Sucker", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));
        //ItemList.FluidExtractorUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11194, "basicmachine.fluidextractor.tier.10", "Epic Liquefying Sucker II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));
        //ItemList.FluidExtractorUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11195, "basicmachine.fluidextractor.tier.11", "Epic Liquefying Sucker III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));
        //ItemList.FluidExtractorUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11196, "basicmachine.fluidextractor.tier.12", "Epic Liquefying Sucker IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));
        //ItemList.FluidExtractorUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11197, "basicmachine.fluidextractor.tier.13", "Epic Liquefying Sucker V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));
        //ItemList.FluidExtractorOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11198, "basicmachine.fluidextractor.tier.14", "Epic Liquefying Sucker VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidExtractionRecipes, 1, 1, 16000, 0, 1, "FluidExtractor.png", GregTech_API.sSoundList.get(200), false, false, 0, "FLUID_EXTRACTOR", null).getStackForm(1L));


        //FluidHeater
        //ItemList.FluidHeaterUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11203, "basicmachine.fluidheater.tier.09", "Epic Heat Infuser", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));
        //ItemList.FluidHeaterUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11204, "basicmachine.fluidheater.tier.10", "Epic Heat Infuser II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));
        //ItemList.FluidHeaterUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11205, "basicmachine.fluidheater.tier.11", "Epic Heat Infuser III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));
        //ItemList.FluidHeaterUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11206, "basicmachine.fluidheater.tier.12", "Epic Heat Infuser IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));
        //ItemList.FluidHeaterUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11207, "basicmachine.fluidheater.tier.13", "Epic Heat Infuser V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));
        //ItemList.FluidHeaterOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11208, "basicmachine.fluidheater.tier.14", "Epic Heat Infuser VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sFluidHeaterRecipes, 1, 0, 8000, 0, 1, "FluidHeater.png", "", false, false, 0, "FLUID_HEATER", null).getStackForm(1L));


        //Mixer
        //ItemList.MixerUHV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11213, "basicmachine.mixer.tier.09", "Epic Matter Organizer", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 72000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));
        //ItemList.MixerUEV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11214, "basicmachine.mixer.tier.10", "Epic Matter Organizer II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 96000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));
        //ItemList.MixerUIV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11215, "basicmachine.mixer.tier.11", "Epic Matter Organizer III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 128000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));
        //ItemList.MixerUMV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11216, "basicmachine.mixer.tier.12", "Epic Matter Organizer IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 128000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));
        //ItemList.MixerUXV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11217, "basicmachine.mixer.tier.13", "Epic Matter Organizer V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 128000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));
        //ItemList.MixerOPV.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(11218, "basicmachine.mixer.tier.14", "Epic Matter Organizer VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sMixerRecipes, 6, 1, 128000, 0, 1, "Mixer.png", "", false, false, 0, "MIXER", null).getStackForm(1L));

        //Circuit Assembler
        //ItemList.Machine_UHV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12080, "basicmachine.circuitassembler.tier.09", "Epic Circuit Assembling Machine", 9, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", new Object[]{"ACE", "VMV", aTextWireCoil, 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'V', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR, 'A', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.ROBOT_ARM, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.BETTER_CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER}).getStackForm(1L));
        //ItemList.Machine_UEV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12081, "basicmachine.circuitassembler.tier.10", "Epic Circuit Assembling Machine II", 10, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", new Object[]{"ACE", "VMV", aTextWireCoil, 'M', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.HULL, 'V', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.CONVEYOR, 'A', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.ROBOT_ARM, 'C', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.BETTER_CIRCUIT, 'W', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.WIRE, 'E', GT_MetaTileEntity_BasicMachine_GT_Recipe.X.EMITTER}).getStackForm(1L));
        //ItemList.Machine_UIV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12082, "basicmachine.circuitassembler.tier.11", "Epic Circuit Assembling Machine III", 11, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", null).getStackForm(1L));
        //ItemList.Machine_UMV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12083, "basicmachine.circuitassembler.tier.12", "Epic Circuit Assembling Machine IV", 12, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", null).getStackForm(1L));
        //ItemList.Machine_UXV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12084, "basicmachine.circuitassembler.tier.13", "Epic Circuit Assembling Machine V", 13, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", null).getStackForm(1L));
        //ItemList.Machine_OPV_CircuitAssembler.set(new GT_MetaTileEntity_BasicMachine_GT_Recipe(12085, "basicmachine.circuitassembler.tier.14", "Epic Circuit Assembling Machine VI", 14, EnumChatFormatting.DARK_RED + "REMOVED", GT_Recipe.GT_Recipe_Map.sCircuitAssemblerRecipes, 6, 1, 16000, 0, 1, "CircuitAssembler.png", "", false, false, 0, "CIRCUITASSEMBLER", null).getStackForm(1L));
