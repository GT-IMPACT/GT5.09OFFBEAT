...
public class GT_Worldgenloader
    ...
    public void run() {
        ...
        new GT_Worldgen_GT_Ore_Layer("ore.mix.nickel", true, 10, 40, 40, 2, 16, true, true, true, Materials.Garnierite, Materials.Nickel, Materials.Cobaltite, Materials.Pentlandite);
        ...
        new GT_Worldgen_GT_Ore_Layer("ore.mix.quartz", true, 40, 80, 30, 2, 16, true, true, false, Materials.Quartzite, Materials.Barite, Materials.CertusQuartz, Materials.CertusQuartz);
