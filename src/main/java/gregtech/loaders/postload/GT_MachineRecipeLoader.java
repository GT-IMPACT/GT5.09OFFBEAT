...
//Circuit Recipes!!!
        ...
        GT_Values.RA.addUniversalDistillationRecipe(new FluidStack(ItemList.sOilExtraHeavy, 100), new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(750), Materials.SulfuricTar.getFluid(200), Materials.SulfuricLightFuel.getFluid(70), Materials.SulfuricNaphtha.getFluid(40), Materials.SulfuricGas.getGas(300)}, null, 20, 834);
        ...
        GT_Values.RA.addChemicalRecipe(new ItemStack(Items.sugar, 8), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Plastic, 1), new FluidStack(ItemList.sToluene, 1131), GT_Values.NF, ItemList.GelledToluene.get(8), 200, 192);
...
//        Field Generator
    ...
    public void run3() {
        ...
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.EnderPearl, 1L), GT_ModHandler.getDistilledWater(100), new ItemStack(Items.ender_pearl, 1, 0), 9000, 1200, 30);
