...
//        Field Generator
    ...
    private void addRecipesApril2017ChemistryUpdate() {
        ...
        GT_Values.RA.addUniversalDistillationRecipe(Materials.SaltWater.getFluid(2000), new FluidStack[]{GT_ModHandler.getDistilledWater(1000)}, Materials.Salt.getDust(1), 3200, 16);
    ...
    public void run3() {
        ...
        GT_Values.RA.addCrackingRecipe(24, Materials.PerroxSuperHeavy.getFluid(100), Materials.Nickel.getPlasma(1), Materials.PerroxSuperHeavyCracked.getGas(100), 200, 196608);
        GT_Values.RA.addCrackingRecipe(24, Materials.PerroxHeavy.getFluid(100), Materials.Zinc.getPlasma(1), Materials.PerroxHeavyCracked.getGas(100), 200, 196608);
        GT_Values.RA.addCrackingRecipe(24, Materials.PerroxLight.getFluid(100), Materials.Niobium.getPlasma(1), Materials.PerroxLightCracked.getGas(100), 200, 196608);
        GT_Values.RA.addCrackingRecipe(24, Materials.PerroxSuperLight.getFluid(100), Materials.Silver.getPlasma(1), Materials.PerroxSuperLightCracked.getGas(100), 200, 196608);
