...
//        Field Generator
    ...
    private void addRecipesApril2017ChemistryUpdate() {
        ...
        RA.addChemicalRecipe(GT_ModHandler.getModItem("IC2", "itemCellEmpty", 2, 12), GT_Utility.getIntegratedCircuit(11), Materials.Methane.getGas(1000), Materials.Hydrogen.getGas(8000), Materials.CarbonDioxide.getCells(1), Materials.Empty.getCells(1), 280, 480);
        ...
        RA.addChemicalRecipe(GT_ModHandler.getModItem("IC2", "itemCellEmpty", 2, 12), GT_Utility.getIntegratedCircuit(12), Materials.Methane.getGas(1000), Materials.Hydrogen.getGas(8000), Materials.Empty.getCells(2), 280, 480);
