...
//        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gunpowder, 4L), new ItemStack(Blocks.sand, 4, 32767), new ItemStack(Blocks.tnt, 1), 400, 1);
    ...
    private void run2() {
        ...
        GT_Values.RA.addLatheRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.ReinforcedGlass, 4L), GT_OreDictUnificator.get(OrePrefixes.lens, Materials.ReinforcedGlass, 4L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glass, 1L), 400, 16);
