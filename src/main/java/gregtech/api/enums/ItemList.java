...
public enum ItemList implements IItemContainer {
    ...
    Conveyor_Module_LV, Conveyor_Module_MV, Conveyor_Module_HV, Conveyor_Module_EV, Conveyor_Module_IV, Conveyor_Module_LuV, Conveyor_Module_ZPM, Conveyor_Module_UV, Conveyor_Module_UHV, Conveyor_Module_UEV,
    Electric_Piston_LV, Electric_Piston_MV, Electric_Piston_HV, Electric_Piston_EV, Electric_Piston_IV, Electric_Piston_LuV, Electric_Piston_ZPM, Electric_Piston_UV, Electric_Piston_UHV, Electric_Piston_UEV,
    Field_Generator_LV, Field_Generator_MV, Field_Generator_HV, Field_Generator_EV, Field_Generator_IV, Field_Generator_LuV, Field_Generator_ZPM, Field_Generator_UV, Field_Generator_UHV, Field_Generator_UEV,
    Robot_Arm_LV, Robot_Arm_MV, Robot_Arm_HV, Robot_Arm_EV, Robot_Arm_IV, Robot_Arm_LuV, Robot_Arm_ZPM, Robot_Arm_UV, Robot_Arm_UHV, Robot_Arm_UEV,
    Emitter_LV, Emitter_MV, Emitter_HV, Emitter_EV, Emitter_IV, Emitter_LuV, Emitter_ZPM, Emitter_UV, Emitter_UHV, Emitter_UEV,
    Sensor_LV, Sensor_MV, Sensor_HV, Sensor_EV, Sensor_IV, Sensor_LuV, Sensor_ZPM, Sensor_UV, Sensor_UHV, Sensor_UEV,
    ...
    Casing_ULV, Casing_LV, Casing_MV, Casing_HV, Casing_EV, Casing_IV, Casing_LuV, Casing_ZPM, Casing_UV, Casing_MAX, Casing_UEV, Casing_UIV, Casing_UMV, Casing_UXV, Casing_OPV, Casing_MAXV, Casing_BronzePlatedBricks, Casing_HeatProof, Casing_Coil_Superconductor,
    ...
    Machine_Multi_LargeChemicalReactor, Machine_IndustrialPulverizer, Machine_FlotationUnit, Machine_MultiblockCentrifuge, Machine_MultiblockElectrolyzer, Machine_MultiblockTesseract, Machine_MultiblockTinyWormHole,
    ...
    Depleted_Thorium_1, Depleted_Thorium_2, Depleted_Thorium_4, Depleted_MThCell_1, Depleted_MThCell_2, Depleted_MThCell_4,
    ...
    Casing_Coil_Cupronickel, Casing_Coil_Kanthal, Casing_Coil_Nichrome, Casing_Coil_TungstenSteel, Casing_Coil_HSSG, Casing_Coil_Naquadah, Casing_Coil_NaquadahAlloy, Casing_Coil_ElectrumFlux, Casing_Coil_Diamericiumtitanium, Casing_Coil_Infinity,
    ...
    Honeycomb, Charcoal_Pile, Block_BrittleCharcoal,
    OilDrill1, OilDrill2, OilDrill3, ConcreteBackfiller1, ConcreteBackfiller2, OreDrill1, OreDrill2, OreDrill3, OreDrill4, OreDrill5, PyrolyseOven, OilCracker, Crop_Drop_UUMBerry, Crop_Drop_UUABerry, Empty_Board_Basic, Empty_Board_Elite,
    ...
    Crop_Drop_Bauxite, Crop_Drop_Ilmenite, Crop_Drop_Pitchblende, Crop_Drop_Uraninite, Crop_Drop_Thorium, Crop_Drop_Nickel, Crop_Drop_Zinc, Crop_Drop_Manganese, Crop_Drop_Scheelite, Crop_Drop_Platinum, Crop_Drop_Iridium, Crop_Drop_Osmium, Crop_Drop_Naquadah, Crop_Drop_Lapis, Crop_Drop_Olivine, Crop_Drop_Sapphire, Uraniumcell_1, Uraniumcell_2, Uraniumcell_4, Moxcell_1, Moxcell_2, Moxcell_4, MThCell_1, MThCell_2, MThCell_4,
    ...
    Circuit_Parts_ResistorXSMD, Circuit_Parts_DiodeXSMD, Circuit_Parts_TransistorXSMD, Circuit_Parts_CapacitorXSMD, Circuit_Parts_InductorXSMD, Circuit_Wafer_SoC5, Circuit_Chip_SoC5, Circuit_Wafer_SoC6, Circuit_Chip_SoC6,
    Circuit_Naquaprocessor, Circuit_Naquacomputer, Circuit_Naquasupercomputer, Circuit_Xenoprocessor, Circuit_Xenocomputer, Circuit_Xenosupercomputer, Circuit_Cosmicprocessor, Circuit_Cosmiccomputer, Circuit_Cosmicsupercomputer, NaquaBoardEmpty, NaquaBoardFull,
	...
	CanningMachineUHV, CanningMachineUEV, CanningMachineUIV, CanningMachineUMV, CanningMachineUXV, CanningMachineOPV,
	CentrifugeUHV, CentrifugeUEV, CentrifugeUIV, CentrifugeUMV, CentrifugeUXV, CentrifugeOPV,
	ChemicalBathUHV, ChemicalBathUEV, ChemicalBathUIV, ChemicalBathUMV, ChemicalBathUXV, ChemicalBathOPV,
	ChemicalReactorUHV, ChemicalReactorUEV, ChemicalReactorUIV, ChemicalReactorUMV, ChemicalReactorUXV, ChemicalReactorOPV,
	CompressorUHV, CompressorUEV, CompressorUIV, CompressorUMV, CompressorUXV, CompressorOPV,
	CuttingMachineUHV, CuttingMachineUEV, CuttingMachineUIV, CuttingMachineUMV, CuttingMachineUXV, CuttingMachineOPV,
	DisassemblerUHV, DisassemblerUEV, DisassemblerUIV, DisassemblerUMV, DisassemblerUXV, DisassemblerOPV,
	DistilleryUHV, DistilleryUEV, DistilleryUIV, DistilleryUMV, DistilleryUXV, DistilleryOPV,
	ElectricFurnaceUHV, ElectricFurnaceUEV, ElectricFurnaceUIV, ElectricFurnaceUMV, ElectricFurnaceUXV, ElectricFurnaceOPV,
	ElectricOvenUHV, ElectricOvenUEV, ElectricOvenUIV, ElectricOvenUMV, ElectricOvenUXV, ElectricOvenOPV,
	ElectrolyzerUHV, ElectrolyzerUEV, ElectrolyzerUIV, ElectrolyzerUMV, ElectrolyzerUXV, ElectrolyzerOPV,
	ElectromagneticSeparatorUHV, ElectromagneticSeparatorUEV, ElectromagneticSeparatorUIV, ElectromagneticSeparatorUMV, ElectromagneticSeparatorUXV, ElectromagneticSeparatorOPV,
	ExtractorUHV, ExtractorUEV, ExtractorUIV, ExtractorUMV, ExtractorUXV, ExtractorOPV,
	ExtruderUHV, ExtruderUEV, ExtruderUIV, ExtruderUMV, ExtruderUXV, ExtruderOPV,
	FermenterUHV, FermenterUEV, FermenterUIV, FermenterUMV, FermenterUXV, FermenterOPV,
	FluidCannerUHV, FluidCannerUEV, FluidCannerUIV, FluidCannerUMV, FluidCannerUXV, FluidCannerOPV,
	FluidExtractorUHV, FluidExtractorUEV, FluidExtractorUIV, FluidExtractorUMV, FluidExtractorUXV, FluidExtractorOPV,
	FluidHeaterUHV, FluidHeaterUEV, FluidHeaterUIV, FluidHeaterUMV, FluidHeaterUXV, FluidHeaterOPV,
	FluidSolidifierUHV, FluidSolidifierUEV, FluidSolidifierUIV, FluidSolidifierUMV, FluidSolidifierUXV, FluidSolidifierOPV,
	FormingPressUHV, FormingPressUEV, FormingPressUIV, FormingPressUMV, FormingPressUXV, FormingPressOPV,
	ForgeHammerUHV, ForgeHammerUEV, ForgeHammerUIV, ForgeHammerUMV, ForgeHammerUXV, ForgeHammerOPV,
	LatheUHV, LatheUEV, LatheUIV, LatheUMV, LatheUXV, LatheOPV,
	PrecisionLaserEngraverUHV, PrecisionLaserEngraverUEV, PrecisionLaserEngraverUIV, PrecisionLaserEngraverUMV, PrecisionLaserEngraverUXV, PrecisionLaserEngraverOPV,
	MaceratorUHV, MaceratorUEV, MaceratorUIV, MaceratorUMV, MaceratorUXV, MaceratorOPV,
	MassFabricatorUHV, MassFabricatorUEV, MassFabricatorUIV, MassFabricatorUMV, MassFabricatorUXV, MassFabricatorOPV,
	MicrowaveUHV, MicrowaveUEV, MicrowaveUIV, MicrowaveUMV, MicrowaveUXV, MicrowaveOPV,
	MixerUHV, MixerUEV, MixerUIV, MixerUMV, MixerUXV, MixerOPV,
	OreWashingPlantUHV, OreWashingPlantUEV, OreWashingPlantUIV, OreWashingPlantUMV, OreWashingPlantUXV, OreWashingPlantOPV,
	//PackagerLuV, PackagerZPM, PackagerUV,
	PlasmaArcFurnaceUHV, PlasmaArcFurnaceUEV, PlasmaArcFurnaceUIV, PlasmaArcFurnaceUMV,
	PolarizerUHV, PolarizerUEV, PolarizerUIV, PolarizerUMV,
	//PrinterLuV, PrinterZPM, PrinterUV,
	//RockBreakerLuV, RockBreakerZPM, RockBreakerUV,
	RecyclerUHV, RecyclerUEV, RecyclerUIV, RecyclerUMV,
	ReplicatorUHV, ReplicatorUEV, ReplicatorUIV, ReplicatorUMV,
	ScannerUHV, ScannerUEV, ScannerUIV, ScannerUMV,
	SiftingMachineUHV, SiftingMachineUEV, SiftingMachineUIV, SiftingMachineUMV,
	SlicingMachineUHV, SlicingMachineUEV, SlicingMachineUIV, SlicingMachineUMV,
	ThermalCentrifugeUHV, ThermalCentrifugeUEV, ThermalCentrifugeUIV, ThermalCentrifugeUMV,
	//UnpackagerLuV, UnpackagerZPM, UnpackagerUV,
	WiremillUHV, WiremillUEV, WiremillUIV, WiremillUMV,
	...
	Machine_LV_AirGenerator, Machine_MV_AirGenerator, Machine_HV_AirGenerator, Machine_EV_AirGenerator, Machine_IV_AirGenerator, Machine_LuV_AirGenerator, Machine_ZPM_AirGenerator, Machine_UV_AirGenerator,
    ...
    public static final ItemList[]
            ...
            SPRAY_CAN_DYES = {
                    Spray_Color_00, Spray_Color_01, Spray_Color_02, Spray_Color_03,
                    Spray_Color_04, Spray_Color_05, Spray_Color_06, Spray_Color_07,
                    Spray_Color_08, Spray_Color_09, Spray_Color_10, Spray_Color_11,
                    Spray_Color_12, Spray_Color_13, Spray_Color_14, Spray_Color_15
            },
            SPRAY_CAN_DYES_USED = {
                    Spray_Color_Used_00, Spray_Color_Used_01, Spray_Color_Used_02, Spray_Color_Used_03,
            ...
            TRANSFORMERS = {
                    Transformer_LV_ULV, Transformer_MV_LV, Transformer_HV_MV,
                    Transformer_EV_HV, Transformer_IV_EV, Transformer_LuV_IV,
                    Transformer_ZPM_LuV, Transformer_UV_ZPM, Transformer_MAX_UV
            },
            MACHINE_HULLS = {
                    Hull_ULV, Hull_LV, Hull_MV,
                    Hull_HV, Hull_EV, Hull_IV,
                    Hull_LuV, Hull_ZPM, Hull_UV, Hull_MAX
            },
            CASINGS = {
                    Casing_ULV, Casing_LV, Casing_MV,
                    Casing_HV, Casing_EV, Casing_IV,
                    Casing_LuV, Casing_ZPM, Casing_UV, Casing_MAX
            },
            HATCHES_DYNAMO = {
                    Hatch_Dynamo_ULV, Hatch_Dynamo_LV, Hatch_Dynamo_MV,
                    Hatch_Dynamo_HV, Hatch_Dynamo_EV, Hatch_Dynamo_IV,
                    Hatch_Dynamo_LuV, Hatch_Dynamo_ZPM, Hatch_Dynamo_UV, Hatch_Dynamo_MAX
            },
            HATCHES_ENERGY = {
                    Hatch_Energy_ULV, Hatch_Energy_LV, Hatch_Energy_MV,
                    Hatch_Energy_HV, Hatch_Energy_EV, Hatch_Energy_IV,
                    Hatch_Energy_LuV, Hatch_Energy_ZPM, Hatch_Energy_UV, Hatch_Energy_MAX
            },
            HATCHES_INPUT = {
                    Hatch_Input_ULV, Hatch_Input_LV, Hatch_Input_MV,
                    Hatch_Input_HV, Hatch_Input_EV, Hatch_Input_IV,
                    Hatch_Input_LuV, Hatch_Input_ZPM, Hatch_Input_UV,
                    Hatch_Input_MAX
            },
            HATCHES_INPUT_BUS = {
                    Hatch_Input_Bus_ULV, Hatch_Input_Bus_LV, Hatch_Input_Bus_MV,
                    Hatch_Input_Bus_HV, Hatch_Input_Bus_EV, Hatch_Input_Bus_IV,
                    Hatch_Input_Bus_LuV, Hatch_Input_Bus_ZPM, Hatch_Input_Bus_UV, Hatch_Input_Bus_MAX
            },
            HATCHES_OUTPUT = {
                    Hatch_Output_ULV, Hatch_Output_LV, Hatch_Output_MV,
                    Hatch_Output_HV, Hatch_Output_EV, Hatch_Output_IV,
                    Hatch_Output_LuV, Hatch_Output_ZPM, Hatch_Output_UV, Hatch_Output_MAX
            },
            HATCHES_OUTPUT_BUS = {
                    Hatch_Output_Bus_ULV, Hatch_Output_Bus_LV, Hatch_Output_Bus_MV,
                    Hatch_Output_Bus_HV, Hatch_Output_Bus_EV, Hatch_Output_Bus_IV,
                    Hatch_Output_Bus_LuV, Hatch_Output_Bus_ZPM, Hatch_Output_Bus_UV, Hatch_Output_Bus_MAX
            },
            HATCHES_MUFFLER = {
                    Hatch_Muffler_LV, Hatch_Muffler_LV, Hatch_Muffler_MV,
                    Hatch_Muffler_HV, Hatch_Muffler_EV, Hatch_Muffler_IV,
                    Hatch_Muffler_LuV, Hatch_Muffler_ZPM, Hatch_Muffler_UV, Hatch_Muffler_MAX
            };
    public static Fluid
            sOilExtraHeavy,
            sEpichlorhydrin,
