...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static void genMaterials() {
        ...
        DraconiumAwakened = new Materials(976, TextureSet.SET_SHINY, 80.0F, 122880, 10, 1 | 2 | 8 | 64 | 128, 244, 78, 0, 0, "DraconiumAwakened", "Awakened Meitnerium", 0, 0, 9000, 10000, true, false, 3, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();
