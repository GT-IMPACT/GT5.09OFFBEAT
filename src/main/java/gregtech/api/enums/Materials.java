...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials _NULL, Aluminium, Americium, Antimony, Argon, Arsenic, Barium, Beryllium, Bismuth, Boron, Caesium, Calcium, Carbon, Cadmium, Cerium, Chlorine, Chrome, Cobalt, Copper, Deuterium,
            ...
            GasolinePremium, Oriharukon, MysteriousCrystal, EnrichedMysteriousCrystal, Longasssuperconductornameforlvwire, Pentacadmiummagnesiumhexaoxid, Titaniumonabariumdecacoppereikosaoxid, Uraniumtriplatinid, Vanadiumtriindinid,
            ...
            SuperconductorLV, SuperconductorMV, SuperconductorHV, SuperconductorEV, SuperconductorIV, SuperconductorLuV, SuperconductorZPM, SuperconductorUV, SuperconductorUEV, Diamericiumtitanium, Europiumoxide, EuropiumoxideMagnetic,
    ...
    public static void genMaterials() {
        ...
        Osmium = new Materials(83, TextureSet.SET_METALLIC, 16.0F, 1280, 4, 1 | 2 | 8 | 32 | 64 | 128, 50, 50, 255, 0, "Osmium", "Osmium", 0, 0, 3306, 4500, true, false, 10, 1, 1, Dyes.dyeBlue, Element.Os).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Titanium = new Materials(28, TextureSet.SET_METALLIC, 7.0F, 1600, 3, 1 | 2 | 8 | 32 | 64 | 128, 220, 160, 240, 0, "Titanium", "Titanium", 0, 0, 1941, 1940, true, false, 5, 1, 1, Dyes.dyePurple, Element.Ti).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Tungsten = new Materials(81, TextureSet.SET_METALLIC, 7.0F, 2560, 3, 1 | 2 | 8 | 32 | 64 | 128, 50, 50, 50, 0, "Tungsten", "Tungsten", 0, 0, 3695, 3000, true, false, 4, 1, 1, Dyes.dyeBlack, Element.W).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Draconium = new Materials(975, TextureSet.SET_SHINY, 40.0F, 65536, 7, 1 | 2 | 8 | 64 | 128, 122, 68, 176, 0, "Draconium", "Meitnerium", 0, 0, 5000, 7200, true, false, 3, 1, 1, Dyes.dyePink).disableAutoGeneratedBlastFurnaceRecipes();
        DraconiumAwakened = new Materials(976, TextureSet.SET_SHINY, 80.0F, 122880, 10, 1 | 2 | 8 | 64 | 128, 244, 78, 0, 0, "DraconiumAwakened", "Enriched Meitnerium", 0, 0, 9000, 10000, true, false, 3, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();
         ...
         */
        Adamantium = new Materials(319, TextureSet.SET_SHINY, 30.0F, 16384, 9, 1 | 2 | 8 | 64 | 128, 255, 255, 255, 0, "Adamantium", "Adamantium", 0, 0, 7200, 10800, true, false, 1, 1, 1, Dyes.dyeLightGray).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Graphene = new Materials(819, TextureSet.SET_DULL, 6.0F, 32, 1, 1 | 2, 128, 128, 128, 0, "Graphene", "Graphene", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeGray);
        ...
        HSLA = new Materials(322, TextureSet.SET_METALLIC, 6.0F, 500, 2, 1 | 2 | 128, 128, 128, 128, 0, "HSLA", "HSLA Steel", 0, 0, 1811, 1811, true, false, 3, 1, 1, Dyes._NULL).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        NobleGases = new Materials(496, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 169, 208, 245, 240, "NobleGases", "Noble Gases", 0, 0, 4, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 2, Arrays.asList()).setHasCorrespondingFluid(true).setLiquidTemperature(79);
        ...
        LiquidAir = new Materials(495, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 169, 208, 245, 240, "LiquidAir", "Liquid Air", 0, 0, 4, 0, false, true, 1, 1, 1, Dyes.dyeLightBlue, 2, Arrays.asList()).setHasCorrespondingFluid(true).setLiquidTemperature(79);
        ...
        Bronze = new Materials(300, TextureSet.SET_METALLIC, 6.0F, 384, 3, 1 | 2 | 64 | 128, 255, 128, 0, 0, "Bronze", "Bronze", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeOrange, 2, Arrays.asList(new MaterialStack(Tin, 1), new MaterialStack(Copper, 3)));
        ...
        Rutile = new Materials(375, TextureSet.SET_GEM_HORIZONTAL, 1.0F, 0, 2, 1 | 4 | 8, 212, 13, 92, 0, "Rutile", "Rutile", 0, 0, -1, 0, false, false, 1, 2, 1, Dyes.dyeRed, 0, Arrays.asList(new MaterialStack(Titanium, 1), new MaterialStack(Oxygen, 2)));
        ...
        HydricSulfide = new Materials(460, TextureSet.SET_FLUID, 1.0F, 0, 2, 16, 255, 255, 255, 0, "HydricSulfide", "Hydrogen Sulfide", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeOrange, 1, Arrays.asList(new MaterialStack(Hydrogen, 2), new MaterialStack(Sulfur, 1)));
        ...
        BioDiesel = new MaterialBuilder(627, TextureSet.SET_FLUID, "Bio Diesel").addCell().addFluid().setRGB(255, 128, 0).setColor(Dyes.dyeOrange).setFuelType(MaterialBuilder.DIESEL).setFuelPower(320).constructMaterial();
        ...
        Butene = new MaterialBuilder(645, TextureSet.SET_FLUID, "Butene").addCell().addGas().setRGB(207, 80, 5).setColor(Dyes.dyeOrange).setMaterialList(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 8)).addElectrolyzerRecipe().setCanBeCracked(true).constructMaterial();
        Butadiene = new MaterialBuilder(646, TextureSet.SET_FLUID, "Butadiene").addCell().addGas().setRGB(232, 105, 0).setColor(Dyes.dyeOrange).setMaterialList(new MaterialStack(Carbon, 4), new MaterialStack(Hydrogen, 6)).addElectrolyzerRecipe().setCanBeCracked(true).constructMaterial();
        ...
        Ethylene = new MaterialBuilder(677, TextureSet.SET_FLUID, "Ethylene").addCell().addGas().setRGB(225, 225, 225).setColor(Dyes.dyeWhite).setMaterialList(new MaterialStack(Carbon, 2), new MaterialStack(Hydrogen, 4)).addElectrolyzerRecipe().setCanBeCracked(true).constructMaterial();
        Propene = new MaterialBuilder(678, TextureSet.SET_FLUID, "Propene").addCell().addGas().setRGB(255, 221, 85).setColor(Dyes.dyeYellow).setMaterialList(new MaterialStack(Carbon, 3), new MaterialStack(Hydrogen, 6)).addElectrolyzerRecipe().setCanBeCracked(true).constructMaterial();
        ...
        Benzene = new MaterialBuilder(686, TextureSet.SET_FLUID, "Benzene").addCell().addFluid().setRGB(26, 26, 26).setColor(Dyes.dyeGray).setFuelType(MaterialBuilder.GAS).setFuelPower(360).setMaterialList(new MaterialStack(Carbon, 6), new MaterialStack(Hydrogen, 6)).addElectrolyzerRecipe().constructMaterial();
        ...
        Uvarovite = new Materials(842, TextureSet.SET_DIAMOND, 1.0F, 0, 2, 1 | 8, 180, 255, 180, 0, "Uvarovite", "Uvarovite", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeGreen, 1, Arrays.asList(new MaterialStack(Calcium, 3), new MaterialStack(Chrome, 2), new MaterialStack(Silicon, 3), new MaterialStack(Oxygen, 12)));
        VanadiumGallium = new Materials(357, TextureSet.SET_SHINY, 1.0F, 0, 2, 1 | 2, 128, 128, 140, 0, "VanadiumGallium", "Vanadium-Gallium", 0, 0, 4500, 4500, true, false, 1, 1, 1, Dyes.dyeGray, 2, Arrays.asList(new MaterialStack(Vanadium, 3), new MaterialStack(Gallium, 1))).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        YttriumBariumCuprate = new Materials(358, TextureSet.SET_METALLIC, 1.0F, 0, 2, 1 | 2, 80, 64, 70, 0, "YttriumBariumCuprate", "Yttrium Barium Cuprate", 0, 0, 4500, 4500, true, false, 1, 1, 1, Dyes.dyeGray, 0, Arrays.asList(new MaterialStack(Yttrium, 1), new MaterialStack(Barium, 2), new MaterialStack(Copper, 3), new MaterialStack(Oxygen, 7))).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Perlite = new Materials(925, TextureSet.SET_DULL, 1.0F, 0, 1, 1 | 8, 30, 20, 30, 0, "Perlite", "Perlite", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeBlack, 2, Arrays.asList(new MaterialStack(Obsidian, 2), new MaterialStack(Water, 1)));
        ...
        EnderPearl = new Materials(532, TextureSet.SET_SHINY, 1.0F, 16, 1, 1 | 4, 108, 220, 200, 0, "EnderPearl", "Enderpearl", 0, 0, -1, 0, false, false, 1, 16, 10, Dyes.dyeGreen, 0, Arrays.asList(new MaterialStack(Beryllium, 1), new MaterialStack(Potassium, 4), new MaterialStack(Nitrogen, 5)));
        ...
        NitroFuel = new Materials(709, TextureSet.SET_FLUID, 1.0F, 0, 2, 16, 200, 255, 0, 0, "NitroFuel", "Cetane-Boosted Diesel", 0, 1000, -1, 0, false, false, 1, 1, 1, Dyes.dyeLime);
        ...
        RedAlloy = new Materials(308, TextureSet.SET_DULL, 1.0F, 0, 0, 1 | 2, 200, 0, 0, 0, "RedAlloy", "Red Alloy", 0, 0, 500, 0, false, false, 3, 1, 1, Dyes.dyeRed, 2, Arrays.asList(new MaterialStack(Copper, 1), new MaterialStack(Redstone, 4)));
        ...
        Marble = new Materials(845, TextureSet.SET_FINE, 1.0F, 16, 1, 1, 200, 200, 200, 0, "Marble", "Marble", 0, 0, -1, 0, false, false, 1, 1, 1, Dyes.dyeWhite, 2, Arrays.asList(new MaterialStack(Magnesium, 1), new MaterialStack(Calcite, 7)));
        ...
        GraniteBlack = new Materials(849, TextureSet.SET_ROUGH, 4.0F, 64, 3, 1, 10, 10, 10, 0, "GraniteBlack", "Black Granite", 0, 0, -1, 0, false, false, 0, 1, 1, Dyes.dyeBlack, 2, Arrays.asList(new MaterialStack(SiliconDioxide, 4), new MaterialStack(Biotite, 1)));
        GraniteRed = new Materials(850, TextureSet.SET_ROUGH, 4.0F, 64, 3, 1, 255, 0, 128, 0, "GraniteRed", "Red Granite", 0, 0, -1, 0, false, false, 0, 1, 1, Dyes.dyeMagenta, 1, Arrays.asList(new MaterialStack(Aluminium, 2), new MaterialStack(PotassiumFeldspar, 1), new MaterialStack(Oxygen, 3)));
        ...
        Dimethylbenzene = new MaterialBuilder(593, TextureSet.SET_FLUID, "Dimethylbenzene").addCell().addFluid().setRGB(102, 156, 64).setColor(Dyes.dyeLime).setFuelType(MaterialBuilder.GAS).setFuelPower(296).setMaterialList(new MaterialStack(Carbon, 8), new MaterialStack(Hydrogen, 10)).constructMaterial();
        ...
        GasolinePremium = new MaterialBuilder(998, TextureSet.SET_FLUID, "High Octane Gasoline").addCell().addFluid().setRGB(255, 165, 0).setColor(Dyes.dyeOrange).setFuelType(MaterialBuilder.DIESEL).setFuelPower(2500).constructMaterial();
        ...
        InfinityCatalyst = new Materials(401, TextureSet.SET_SHINY, 128.0F, 1310720, 10, 1 | 2 | 8 | 64 | 128, 255, 255, 255, 0, "InfinityCatalyst", "Infinity Catalyst", 5, 500000, 12600, 12600, true, false, 20, 1, 1, Dyes.dyeLightGray).disableAutoGeneratedBlastFurnaceRecipes();
        Infinity = new Materials(402, TextureSet.SET_SHINY, 256.0F, 2621440, 17, 1 | 2 | 64 | 128, 255, 255, 255, 0, "Infinity", "Infinity", 5, 5000000, 12600, 12600, true, false, 40, 1, 1, Dyes.dyeWhite).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        BlackPlutonium = new Materials(416, TextureSet.SET_DULL, 64.0F, 122880, 9, 1 | 2 | 8 | 64 | 128, 50, 50, 50, 0, "BlackPlutonium", "Black Plutonium", 0, 0, 10800, 10800, true, false, 4, 1, 1, Dyes.dyeBlack).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        BlueAlloy = new Materials(309, TextureSet.SET_DULL, 1.0F, 0, 0, 1 | 2, 100, 180, 255, 0, "BlueAlloy", "Blue Alloy", 0, 0, -1, 0, false, false, 3, 1, 1, Dyes.dyeLightBlue, 2, Arrays.asList(new MaterialStack(Silver, 1), new MaterialStack(Electrotine, 4)));
        ...
        PerroxPolymer = new Materials(421, TextureSet.SET_DULL, 8.0F, 2000, 3, 1 | 2 | 16 | 64, 50, 150, 70, 0, "PerroxPoly", "Perrox Polymer", 0, 0, 6203, 0, true, false, 1, 1, 1, Dyes.dyeGreen).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Zirconium = new Materials           ( 27, TextureSet.SET_SHINY,128.0F,51200,8,1|2|8, 200,200,210,0,"Zirconium",         "Zirconium",           0,0,2125,2125,true, false,4,1,1, Dyes.dyeLightGray, Element.Zr);
		...
		Californium = new Materials         ( 388, TextureSet.SET_SHINY,128.0F,51200,8,1|2, 220,220,230,0,"Californium",         "Californium",           0,0,2125,2125,true, false,4,1,1, Dyes.dyeLightGray, Element.Cf);
        ...
        Mytryl = new Materials(387, TextureSet.SET_DULL, 8.0F, 512, 4, 1 | 2 | 128, 242, 100, 4, 0, "Mytryl", "Mytryl", 0, 0, 3600, 3600, true, false, 4, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        DraconiumPlasma = new MaterialBuilder(-1, TextureSet.SET_DULL, "Meitnerium Plasma").setRGB(122, 68, 176).addFluid().constructMaterial().setLiquidTemperature(10000);
        DraconiumAwakenedPlasma = new MaterialBuilder(-1, TextureSet.SET_DULL, "Enriched Meitnerium Plasma").setRGB(244, 78, 0).addFluid().constructMaterial().setLiquidTemperature(10800);

        Longasssuperconductornameforlvwire = new Materials(967, TextureSet.SET_METALLIC, 1.0F, 0, 3, 1 | 2, 225, 180, 84, 0, "Longasssuperconductornameforlvwire", "Superconductor Base LV", 0, 0, 1200, 1200, true, false, 1, 1, 1, Dyes.dyeYellow, 1, Arrays.asList(new MaterialStack(Lanthanum, 2), new MaterialStack(Barium, 1), new MaterialStack(Copper, 1), new MaterialStack(Oxygen, 4))).disableAutoGeneratedBlastFurnaceRecipes();
        ...
        Kerosene = new MaterialBuilder(750, TextureSet.SET_FLUID, "Kerosene").addCell().addFluid().setRGB(240, 240, 240).setColor(Dyes.dyeWhite).setFuelType(MaterialBuilder.DIESEL).setFuelPower(576).constructMaterial();
        KeroseneMixture = new MaterialBuilder(751, TextureSet.SET_FLUID, "Kerosene Mixture").addCell().addFluid().setRGB(250, 245, 240).setColor(Dyes.dyeWhite).setFuelType(MaterialBuilder.DIESEL).setFuelPower(690).constructMaterial();
    ...
    static {
		...
		PerroxPolymer			.setEnchantmentForTools(Enchantment.knockback, 3);
    ...
    private static void initSubTags() {
        ...
        SubTag.METAL.addTo(AnyIron, AnyCopper, AnyBronze, Metal, Aluminium, Americium, Antimony, Beryllium, Bismuth, Caesium, Cerium, Chrome, Cobalt, Copper, Europium, Gadolinium, Gallium, Gold,
                ...
                VanadiumSteel, Infinity, InfinityCatalyst, BlackPlutonium, Draconium, DraconiumAwakened, Longasssuperconductornameforlvwire, Pentacadmiummagnesiumhexaoxid,Titaniumonabariumdecacoppereikosaoxid,
        ...
        CokeCoal.add(SubTag.FLAMMABLE, SubTag.NO_SMELTING, SubTag.NO_SMASHING, SubTag.MORTAR_GRINDABLE);
        ...
        PerroxPolymer.add(SubTag.FLAMMABLE, SubTag.NO_SMASHING, SubTag.BOUNCY);
        ...
        SuperconductorLV        .add(SubTag.NO_SMASHING, SubTag.NO_SMELTING);
