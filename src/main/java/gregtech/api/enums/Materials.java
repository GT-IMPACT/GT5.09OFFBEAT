...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials _NULL, Aluminium, Americium, Antimony, Argon, Arsenic, Barium, Beryllium, Bismuth, Boron, Caesium, Calcium, Carbon, Cadmium, Cerium, /*Chlorine,*/ Chrome, Cobalt, Copper, Deuterium,
            ...
            //fix Chemical
            EuropiumNitrate, CadmiumPeroxide, BariumCarbonat, 
    ...
    public static void genMaterials() {
        ...
        Chlorine = new Materials(23, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 255, 255, 255, 0, "Chlorine", "Chlorine", 0, 0, 171, 0, false, false, 2, 1, 1, Dyes.dyeCyan, true, "Cl\u2082");
        ...
        Fluorine = new Materials(14, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 255, 255, 255, 127, "Fluorine", "Fluorine", 0, 0, 53, 0, false, true, 2, 1, 1, Dyes.dyeGreen, true, "F\u2082");
        ...
        Hydrogen = new Materials(1, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 0, 0, 255, 240, "Hydrogen", "Hydrogen", 1, 20, 14, 0, false, true, 2, 1, 1, Dyes.dyeBlue, true, "H\u2082");
        ...
        Nitrogen = new Materials(12, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 0, 150, 200, 240, "Nitrogen", "Nitrogen", 0, 0, 63, 0, false, true, 2, 1, 1, Dyes.dyeCyan, true, "N\u2082");
        ...
        Oxygen = new Materials(13, TextureSet.SET_FLUID, 1.0F, 0, 2, 16 | 32, 0, 100, 200, 240, "Oxygen", "Oxygen", 0, 0, 54, 0, false, true, 1, 1, 1, Dyes.dyeWhite, true, "O\u2082");
		...
		//Fixed Chemistry
        EuropiumNitrate = new MaterialBuilder(235, TextureSet.SET_POWDER, "Europium Nitrate").setRGB(255, 255, 255).setColor(Dyes.dyeWhite).constructMaterial();
        CadmiumPeroxide = new MaterialBuilder(236, TextureSet.SET_POWDER, "Cadmium Peroxide").setRGB(154, 48, 1).setColor(Dyes.dyeBrown).constructMaterial();
    ...
    public Materials(int aMetaItemSubID, TextureSet aIconSet, float aToolSpeed, int aDurability, int aToolQuality, int aTypes, int aR, int aG, int aB, int aA, String aName, String aDefaultLocalName, int aFuelType, int aFuelPower, int aMeltingPoint, int aBlastFurnaceTemp, boolean aBlastFurnaceRequired, boolean aTransparent, int aOreValue, int aDensityMultiplier, int aDensityDivider, Dyes aColor, boolean FixElementEnable, String aElement) {
        this(aMetaItemSubID, aIconSet, aToolSpeed, aDurability, aToolQuality, aTypes, aR, aG, aB, aA, aName, aDefaultLocalName, aFuelType, aFuelPower, aMeltingPoint, aBlastFurnaceTemp, aBlastFurnaceRequired, aTransparent, aOreValue, aDensityMultiplier, aDensityDivider, aColor);
        mElement.mLinkedMaterials.add(this);
        mChemicalFormula = aElement;
    }
