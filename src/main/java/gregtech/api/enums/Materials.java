...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static void genMaterials() {
        ...
        Draconium = new Materials(975, TextureSet.SET_SHINY, 40.0F, 65536, 7, 1 | 2 | 8 | 64 | 128, 122, 68, 176, 0, "Draconium", "Draconium", 0, 0, 5000, 7200, true, false, 3, 1, 1, Dyes.dyePink).disableAutoGeneratedBlastFurnaceRecipes();
        DraconiumAwakened = new Materials(976, TextureSet.SET_SHINY, 80.0F, 122880, 10, 1 | 2 | 8 | 64 | 128, 244, 78, 0, 0, "DraconiumAwakened", "Awakened Draconium", 0, 0, 9000, 10000, true, false, 3, 1, 1, Dyes.dyeOrange).disableAutoGeneratedBlastFurnaceRecipes();
