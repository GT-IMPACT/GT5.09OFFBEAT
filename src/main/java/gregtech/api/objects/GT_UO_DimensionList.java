...
public class GT_UO_DimensionList {
    ...
    public void SetDafultValues() {
        SetConfigValues("Overworld", "0", "gas_natural_gas", "gas_natural_gas", 100, 700, 20, 7);
        SetConfigValues("Overworld", "0", "liquid_light_oil", "liquid_light_oil", 90, 650, 20, 6);
        SetConfigValues("Overworld", "0", "liquid_medium_oil", "liquid_medium_oil", 80, 600, 20, 5);
        SetConfigValues("Overworld", "0", "liquid_heavy_oil", "liquid_heavy_oil", 70, 550, 20, 4);
        SetConfigValues("Overworld", "0", "oil", "oil", 80, 600, 20, 5);
        ...
        SetConfigValues("Europa", "Europa", "liquid_extra_heavy_oil", "liquid_extra_heavy_oil", 80, 400, 20, 3);
        SetConfigValues("Europa", "Europa", "liquid_heavy_oil", "liquid_heavy_oil", 200, 800, 30, 1);
        ...
        SetConfigValues("Enceladus", "Enceladus", "molten_glowstone", "molten.glowstone", 0, 400, 10, 5);
        // T6
        SetConfigValues("Triton", "Triton", "molten_indium", "molten.indium", 0, 300, 5, 5);
        ...
        SetConfigValues("Proteus", "Proteus", "molten_lutetium", "molten.lutetium", 0, 100, 10, 3);
        // T7
        SetConfigValues("Pluto", "Pluto", "ethylene", "ethylene", 400, 800, 60, 3);
