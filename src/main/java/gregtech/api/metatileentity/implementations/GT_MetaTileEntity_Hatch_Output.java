...
public class GT_MetaTileEntity_Hatch_Output extends GT_MetaTileEntity_Hatch {
    ...
    protected void doDisplayThings() {
        ...
        if (lockedFluidName == null && mIDFluid < 0) {
            ...
            mInventory[tDisplayStackSlot] = GT_Utility.getFluidDisplayStack(new FluidStack(FluidRegistry.getFluid(mIDFluid), 0), true);
        }
    }
    ...
    public void saveNBTData(NBTTagCompound aNBT) {
        ...
        aNBT.setInteger("mIDFluid", mIDFluid);
    ...
    public void loadNBTData(NBTTagCompound aNBT) {
        ...
        mIDFluid = aNBT.getInteger("mIDFluid");
        ...
        switch (mMode) {
            ...
            case 8:
                ...
                if (mFluid == null) {
                    ...
                    mIDFluid = this.getDrainableStack().getFluidID();
    ...
    public void onEmptyingContainerWhenEmpty() {
        if (this.lockedFluidName == null && this.mFluid != null) {
            ...
            mIDFluid = this.mFluid.getFluidID();
