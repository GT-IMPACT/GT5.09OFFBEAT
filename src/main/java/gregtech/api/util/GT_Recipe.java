...
//		checkCellBalance();
        ...
        if (mInputs.length > 0 && aSpecialValue > 0) {
            switch (aType) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    GT_Recipe_Map.sHyperGenerator.addRecipe(this);
                    break;
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sFermentingRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(50), "gt.recipe.fermenter", "Fermenter", null, RES_PATH_GUI + "basicmachines/Fermenter", 1, 0, 0, 1, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map sBlastRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(800), "gt.recipe.blastfurnace", "Blast Furnace", null, RES_PATH_GUI + "basicmachines/Default", 2, 2, 1, 0, 1, "Heat Capacity: ", 1, " K", true, true);
        ...
        public static final GT_Recipe_Map sVacuumRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(1000), "gt.recipe.vacuumfreezer", "Vacuum Freezer", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map sDustWashRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(300), "gt.recipe.dustwash", "Dust Washer", null, RES_PATH_GUI + "basicmachines/Autoclave", 1, 1, 1, 1, 1, E, 1, E, false, false);
        ...
        public static final GT_Recipe_Map sBenderRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(5000), "gt.recipe.metalbender", "Metal Bender", null, RES_PATH_GUI + "basicmachines/Bender", 2, 1, 2, 0, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map sWireAssemblerRecipes = new GT_Recipe_Map_Assembler(new HashSet<GT_Recipe>(300), "gt.recipe.wireassembler", "Wire Assembler", null, RES_PATH_GUI + "basicmachines/Assembler", 6, 1, 1, 0, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map sCutterRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(5125), "gt.recipe.cuttingsaw", "Cutting Saw", null, RES_PATH_GUI + "basicmachines/Cutter2", 2, 2, 1, 1, 1, E, 1, E, true, true);
        public static final GT_Recipe_Map sSlicerRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(20), "gt.recipe.slicer", "Slicer", null, RES_PATH_GUI + "basicmachines/Slicer", 2, 1, 2, 0, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map sHammerRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(3800), "gt.recipe.hammer", "Hammer", null, RES_PATH_GUI + "basicmachines/Hammer", 1, 1, 1, 0, 1, E, 1, E, true, true);
        public static final GT_Recipe_Map sAmplifiers = new GT_Recipe_Map(new HashSet<GT_Recipe>(2), "gt.recipe.uuamplifier", "UU Amplifier", null, RES_PATH_GUI + "basicmachines/Amplifabricator", 1, 0, 1, 0, 1, E, 1, E, true, true);
        ...
        public static final GT_Recipe_Map_Fuel sMagicFuels = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(100), "gt.recipe.magicfuels", "Magic Fuels", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Fuel Value: ", 1000, " EU", true, true);
        public static final GT_Recipe_Map_Fuel sSmallNaquadahReactorFuels = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(1), "gt.recipe.smallnaquadahreactor", "Small Naquadah Reactor", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Fuel Value: ", 1000, " EU", true, true);
        public static final GT_Recipe_Map_Fuel sLargeNaquadahReactorFuels = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(1), "gt.recipe.largenaquadahreactor", "Large Naquadah Reactor", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Fuel Value: ", 1000, " EU", true, true);
        ...
        public static final GT_Recipe_Map_Fuel sHugeNaquadahReactorFuels = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(1), "gt.recipe.hugenaquadahreactor", "Naquadah Reactor MkIV", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Fuel Value: ", 1000, " EU", true, true);
        public static final GT_Recipe_Map_Fuel sExtraHugeNaquadahReactorFuels = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(1), "gt.recipe.extrahugenaquadahreactor", "Naquadah Reactor MkV", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 0, 0, 1, "Fuel Value: ", 1000, " EU", true, true);
        ...
        /*IMPACT*/
        public static final GT_Recipe_Map sBlastSmelterRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(800), "gt.recipe.blastsmelter", "         Blast Smelter", null, RES_PATH_GUI + "basicmachines/BlastSmelter", 9, 1, 1, 0, 1, "Heat Capacity: ", 1, " K", true, true);
        ...
        public static final GT_Recipe_Map sSawMillVisual = new GT_Recipe_Map(new HashSet<GT_Recipe>(1000), "gt.recipe.sawmill", "Saw Mill", null, RES_PATH_GUI + "Sawmill", 1, 1, 1, 0, 1, E, 1, E, true, false);
            ...
            public static final GT_Recipe_Map sSawMill1 = new GT_Recipe_Map(new HashSet<GT_Recipe>(1000), E, E, null, "", 1, 1, 1, 0, 1, E, 1, E, false, false);
        ...
        public static final GT_Recipe_Map sCyclonRecipes = new GT_Recipe_Map(new HashSet<GT_Recipe>(1000), "gt.recipe.cyclone", "Heavy Metal Cyclone", null, RES_PATH_GUI + "basicmachines/Default", 6, 6, 0, 0, 1, E, 1, E, true, false);
        public static final GT_Recipe_Map_Fuel sHyperGenerator = new GT_Recipe_Map_Fuel(new HashSet<GT_Recipe>(25), "gt.recipe.hypergenerator", "Hyper Generator", null, RES_PATH_GUI + "NaquadahGenerator", 1, 1, 0, 0, 1, "Fuel Value: ", 1, " EU for 1 Amp", true, false);
    ...
    public static class GT_Recipe_Map_MultiblockCentrifugeRecipe extends GT_Recipe_Map{
    	...
    	private static int FLUID_INPUT_COUNT = 2;
    	private static int FLUID_OUTPUT_COUNT = 4;
        ...
        public GT_Recipe addRecipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecial, int[] aOutputChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, int aDuration, int aEUt, int aSpecialValue) {
        	...
        	return addRecipe(new GT_Recipe_Map_MultiblockCentrifuge(aOptimize, aInputs, aOutputs, aSpecial, aOutputChances, aFluidInputs, aFluidOutputs, aDuration, aEUt, aSpecialValue));
        }
         private static class GT_Recipe_Map_MultiblockCentrifuge extends GT_Recipe{
             protected GT_Recipe_Map_MultiblockCentrifuge(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecialItems, int[] aChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, int aDuration, int aEUt, int aSpecialValue) {
            	super(aOptimize, aInputs, aOutputs, aSpecialItems, aChances, aFluidInputs, aFluidOutputs, aDuration, aEUt, aSpecialValue);
            }
    ...
    public static class GT_Recipe_Map_MultiblockElectrolyzerRecipe extends GT_Recipe_Map{
    	private static int INPUT_COUNT = 2;
    	private static int OUTPUT_COUNT = 6;
    	...
    	public GT_Recipe_Map_MultiblockElectrolyzerRecipe() {
            super(new HashSet<GT_Recipe>(200), "gt.recipe.multielectrolyzer", "Multiblock Electrolyzer", null, RES_PATH_GUI + "basicmachines/HugeMachine", INPUT_COUNT, OUTPUT_COUNT, 0, 0, 1, E, 1, E, true, true);
        }
        ...
        public GT_Recipe addRecipe(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecial, int[] aOutputChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, int aDuration, int aEUt, int aSpecialValue) {
        	...
        	return addRecipe(new GT_Recipe_Map_MultiblockElectrolyzer(aOptimize, aInputs, aOutputs, aSpecial, aOutputChances, aFluidInputs, aFluidOutputs, aDuration, aEUt, aSpecialValue));
        }
         private static class GT_Recipe_Map_MultiblockElectrolyzer extends GT_Recipe{
             protected GT_Recipe_Map_MultiblockElectrolyzer(boolean aOptimize, ItemStack[] aInputs, ItemStack[] aOutputs, Object aSpecialItems, int[] aChances, FluidStack[] aFluidInputs, FluidStack[] aFluidOutputs, int aDuration, int aEUt, int aSpecialValue) {
            	super(aOptimize, aInputs, aOutputs, aSpecialItems, aChances, aFluidInputs, aFluidOutputs, aDuration, aEUt, aSpecialValue);
            }
