...
public abstract class GT_Item_Casings_Abstract
    ...
    protected final String mCoil08Tooltip = GT_LanguageManager.addStringLocalization("gt.coil08tooltip", "Base Heating Capacity = 10800 Kelvin");
    protected final String mCoil09Tooltip = GT_LanguageManager.addStringLocalization("gt.coil09tooltip", "Base Heating Capacity = 12600 Kelvin");
    protected final String mCoil10Tooltip = GT_LanguageManager.addStringLocalization("gt.coil10tooltip", "Base Heating Capacity = 19800 Kelvin");
