...
//        ItemList.Circuit_Computer.set(addItem(tLastID = 81, "Processor Assembly", "Advanced Circuit",  new Object[]{OrePrefixes.circuit.get(Materials.Advanced), SubTag.NO_UNIFICATION}));
        ...
        ItemList.EnergyCrystal_LV.set(addItem(tLastID = 200, "Small Energium Crystall (T1)", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 3200000L, GT_Values.V[1], 1L, -3L, true);

        ItemList.EnergyCrystal_MV.set(addItem(tLastID = 201, "Medium Energium Crystall (T2)", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 12800000L, GT_Values.V[2], 2L, -3L, true);

        ItemList.EnergyCrystal_HV.set(addItem(tLastID = 202, "Large Energium Crystall (T3)", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 51200000L, GT_Values.V[3], 3L, -3L, true);

        ItemList.EnergyCrystal_EV.set(addItem(tLastID = 203, "Huge Energium Crystall (T4)", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 204800000L, GT_Values.V[4], 4L, -3L, true);

        ItemList.EnergyCrystal_IV.set(addItem(tLastID = 204, "Energium Orb (T5)", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 819200000L, GT_Values.V[5], 5L, -3L, true);

        ItemList.MysteriousCrystal.set(addItem(tLastID = 205, "Mysterious Energy Crystal", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 5000000000L, GT_Values.V[8], 8L, -3L, true);

        ItemList.MysteriousCrystalOrb.set(addItem(tLastID = 206, "Mysterious Energy Crystal Orb", "Reusable", new Object[0]));
        setElectricStats(32000 + tLastID, 50000000000L, GT_Values.V[9], 9L, -3L, true);

        ItemList.MysteriousCrystalModule.set(addItem(tLastID = 207, "Mysterious Energy Crystal Module", "Reusable", new Object[0]));
